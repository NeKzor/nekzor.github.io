...
var SourceDemoParser = new Parser()
    .endianess("little")
    .array("header", { length: 1, type: headerParser })
    .array("messages", { readUntil: "eof", type: messageParser });

module.exports.SourceDemoParser = SourceDemoParser;

/* var contents = fs.readFileSync("test.dem");
var result = demoParser.parse(contents);
