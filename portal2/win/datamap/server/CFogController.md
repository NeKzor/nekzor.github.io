...
|CFogControllerSetLerpValues|void|0 \| 0x0||
...
|InputSetAngles|string|0 \| 0x0|SetAngles|
|InputSetColor|color32|0 \| 0x0|SetColor|
|InputSetColorLerpTo|color32|0 \| 0x0|SetColorLerpTo|
|InputSetColorSecondary|color32|0 \| 0x0|SetColorSecondary|
|InputSetColorSecondaryLerpTo|color32|0 \| 0x0|SetColorSecondaryLerpTo|
|InputSetDamageFilter|string|0 \| 0x0|SetDamageFilter|
|InputSetEndDist|float|0 \| 0x0|SetEndDist|
|InputSetEndDistLerpTo|float|0 \| 0x0|SetEndDistLerpTo|
|InputSetFarZ|integer|0 \| 0x0|SetFarZ|
|InputSetLocalAngles|string|0 \| 0x0|SetLocalAngles|
|InputSetLocalOrigin|string|0 \| 0x0|SetLocalOrigin|
|InputSetMaxDensity|float|0 \| 0x0|SetMaxDensity|
|InputSetMaxDensityLerpTo|float|0 \| 0x0|SetMaxDensityLerpTo|
...
|InputSetStartDist|float|0 \| 0x0|SetStartDist|
|InputSetStartDistLerpTo|float|0 \| 0x0|SetStartDistLerpTo|
|InputSetTeam|integer|0 \| 0x0|SetTeam|
|InputStartFogTransition|void|0 \| 0x0|StartFogTransition|
...
|m_fog.dirPrimary|vector|864 \| 0x360|fogdir|
|m_fog.colorPrimary|color32|876 \| 0x36c|fogcolor|
|m_fog.colorSecondary|color32|880 \| 0x370|fogcolor2|
|m_fog.colorPrimaryLerpTo|color32|884 \| 0x374||
|m_fog.colorSecondaryLerpTo|color32|888 \| 0x378||
|m_fog.start|float|892 \| 0x37c|fogstart|
|m_fog.end|float|896 \| 0x380|fogend|
|m_fog.farz|float|900 \| 0x384|farz|
|m_fog.maxdensity|float|904 \| 0x388|fogmaxdensity|
|m_fog.startLerpTo|float|908 \| 0x38c||
|m_fog.endLerpTo|float|912 \| 0x390||
|m_fog.maxdensityLerpTo|float|916 \| 0x394||
|m_fog.lerptime|time|920 \| 0x398||
|m_fog.duration|float|924 \| 0x39c|foglerptime|
|m_fog.enable|boolean|928 \| 0x3a0|fogenable|
|m_fog.blend|boolean|929 \| 0x3a1|fogblend|
|m_fog.HDRColorScale|float|932 \| 0x3a4|HDRColorScale|
|m_bUseAngles|boolean|936 \| 0x3a8|use_angles|
|m_iChangedVariables|integer|940 \| 0x3ac||
