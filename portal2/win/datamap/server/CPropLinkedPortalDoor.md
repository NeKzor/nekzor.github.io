...
|CLinkedPortalDoorDisableLinkageThink|void|0 \| 0x0||
|CPropLinkedPortalDoorAnimateThink|void|0 \| 0x0||
|CPropLinkedPortalDoorDisableLinkageThink|void|0 \| 0x0||
...
|InputSetPartner|string|0 \| 0x0|SetPartner|
|InputSetPartner|string|0 \| 0x0|SetPartner|
...
|m_szPartnerName|string|1200 \| 0x4b0|partnername|
|m_szPartnerName|string|1200 \| 0x4b0|partnername|
|m_bIsLinkedToPartner|boolean|1204 \| 0x4b4||
|m_bIsLinkedToPartner|boolean|1204 \| 0x4b4||
|m_nWidth|integer|1212 \| 0x4bc|width|
|m_nHeight|integer|1216 \| 0x4c0|height|
|m_bStartActive|boolean|1220 \| 0x4c4|startactive|
|m_OnOpen|custom|1224 \| 0x4c8|OnOpen|
|m_OnOpen|custom|1224 \| 0x4c8|OnOpen|
|m_OnClose|custom|1248 \| 0x4e0|OnClose|
|m_OnClose|custom|1248 \| 0x4e0|OnClose|
|m_OnEntityTeleportFromMe|custom|1272 \| 0x4f8|OnEntityTeleportFromMe|
|m_OnEntityTeleportFromMe|custom|1272 \| 0x4f8|OnEntityTeleportFromMe|
|m_OnPlayerTeleportFromMe|custom|1296 \| 0x510|OnPlayerTeleportFromMe|
|m_OnPlayerTeleportFromMe|custom|1296 \| 0x510|OnPlayerTeleportFromMe|
|m_OnEntityTeleportToMe|custom|1320 \| 0x528|OnEntityTeleportToMe|
|m_OnEntityTeleportToMe|custom|1320 \| 0x528|OnEntityTeleportToMe|
|m_OnPlayerTeleportToMe|custom|1344 \| 0x540|OnPlayerTeleportToMe|
|m_OnPlayerTeleportToMe|custom|1344 \| 0x540|OnPlayerTeleportToMe|
|m_hPortal|ehandle|1368 \| 0x558||
|m_hPortal|ehandle|1368 \| 0x558||
|m_hPartner|ehandle|1372 \| 0x55c||
|m_hPartner|ehandle|1372 \| 0x55c||
|m_OnFullyOpen|custom|1376 \| 0x560|OnFullyOpen|
|m_OnFullyClosed|custom|1400 \| 0x578|OnFullyClosed|
|m_nSequenceOpen|integer|1424 \| 0x590||
|m_nSequenceOpenIdle|integer|1428 \| 0x594||
|m_nSequenceClose|integer|1432 \| 0x598||
|m_nSequenceCloseIdle|integer|1436 \| 0x59c||
|m_BoneFollowerManager|[CBoneFollowerManager](#cbonefollowermanager)|1440 \| 0x5a0||
