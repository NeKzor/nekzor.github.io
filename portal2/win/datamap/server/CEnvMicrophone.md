...
|m_hMeasureTarget|ehandle|864 \| 0x360||
|m_nSoundMask|integer|868 \| 0x364|SoundMask|
|m_flSensitivity|float|872 \| 0x368|Sensitivity|
|m_flSmoothFactor|float|876 \| 0x36c|SmoothFactor|
|m_flMaxRange|float|880 \| 0x370|MaxRange|
|m_iszSpeakerName|string|884 \| 0x374|SpeakerName|
|m_hSpeaker|ehandle|888 \| 0x378||
|m_iSpeakerDSPPreset|integer|896 \| 0x380|speaker_dsp_preset|
|m_iszListenFilter|string|900 \| 0x384|ListenFilter|
|m_hListenFilter|ehandle|904 \| 0x388||
|m_SoundLevel|custom|908 \| 0x38c|SoundLevel|
|m_OnRoutedSound|custom|932 \| 0x3a4|OnRoutedSound|
|m_OnHeardSound|custom|956 \| 0x3bc|OnHeardSound|
|m_szLastSound|character|980 \| 0x3d4||
