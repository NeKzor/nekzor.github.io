...
|---|:-:|:-:|--:|
|CAmbientGenericRampThink|void|0 \| 0x0||
...
|InputFadeIn|float|0 \| 0x0|FadeIn|
|InputFadeOut|float|0 \| 0x0|FadeOut|
...
|InputPitch|float|0 \| 0x0|Pitch|
|InputPlaySound|void|0 \| 0x0|PlaySound|
...
|InputToggleSound|void|0 \| 0x0|ToggleSound|
|InputUse|void|0 \| 0x0|Use|
|InputVolume|float|0 \| 0x0|Volume|
...
|m_radius|float|860 \| 0x35c|radius|
|m_flMaxRadius|float|864 \| 0x360||
|m_iSoundLevel|integer|868 \| 0x364||
|m_dpv|character|872 \| 0x368||
|m_fActive|boolean|972 \| 0x3cc||
|m_fLooping|boolean|973 \| 0x3cd||
|m_iszSound|soundname|976 \| 0x3d0|message|
|m_sSourceEntName|string|980 \| 0x3d4|SourceEntityName|
