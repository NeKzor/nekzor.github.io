...
|InputCompareValues|input|0 \| 0x0|CompareValues|
...
|InputValue|input|0 \| 0x0|InputValue|
...
|m_OnEqual|custom|860 \| 0x35c|OnEqual|
|m_OnNotEqual|custom|884 \| 0x374|OnNotEqual|
|m_iIntegerValue|integer|908 \| 0x38c|IntegerValue|
|m_iShouldCompareToValue|integer|912 \| 0x390|ShouldComparetoValue|
|m_AllIntCompares|input|916 \| 0x394||
