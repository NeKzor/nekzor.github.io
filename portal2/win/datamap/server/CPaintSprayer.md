...
|m_bStartActive|boolean|860 \| 0x35c|start_active|
|m_nRenderMode|integer|872 \| 0x368|RenderMode|
|m_nAmbientSound|integer|876 \| 0x36c|AmbientSound|
|m_bActive|boolean|880 \| 0x370||
|m_bSilent|boolean|881 \| 0x371|Silent|
|m_bDrawOnly|boolean|882 \| 0x372|DrawOnly|
|m_nBlobRandomSeed|integer|884 \| 0x374||
|m_PaintPowerType|integer|888 \| 0x378|PaintType|
|m_nMaxBlobCount|integer|892 \| 0x37c|maxblobcount|
|m_flBlobsPerSecond|float|896 \| 0x380|blobs_per_second|
|m_flBlobSpreadRadius|float|900 \| 0x384|blob_spread_radius|
|m_flBlobSpreadAngle|float|904 \| 0x388|blob_spread_angle|
|m_flMinSpeed|float|908 \| 0x38c|min_speed|
|m_flMaxSpeed|float|912 \| 0x390|max_speed|
|m_flNoisyBlobPercentage|float|916 \| 0x394||
|m_flPercentageSinceLastNoisyBlob|float|920 \| 0x398||
|m_flStreakPercentage|float|924 \| 0x39c|blob_streak_percentage|
|m_flMinStreakTime|float|928 \| 0x3a0|min_streak_time|
|m_flMaxStreakTime|float|932 \| 0x3a4|max_streak_time|
|m_flMinStreakSpeedDampen|float|936 \| 0x3a8|min_streak_speed_dampen|
|m_flMaxStreakSpeedDampen|float|940 \| 0x3ac|max_streak_speed_dampen|
|m_hPaintStream|ehandle|948 \| 0x3b4||
|m_pFlowSoundLoop|custom|952 \| 0x3b8||
|m_strLightPositionName|string|956 \| 0x3bc|light_position_name|
|m_hLightPositionEntity|ehandle|960 \| 0x3c0||
