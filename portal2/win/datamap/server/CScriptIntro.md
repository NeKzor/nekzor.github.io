...
|CScriptIntroBlendComplete|void|0 \| 0x0||
...
|InputFadeTo|string|0 \| 0x0|FadeTo|
...
|InputSetBlendMode|integer|0 \| 0x0|SetBlendMode|
|InputSetCameraViewEntity|string|0 \| 0x0|SetCameraViewEntity|
|InputSetDamageFilter|string|0 \| 0x0|SetDamageFilter|
|InputSetFadeColor|string|0 \| 0x0|SetFadeColor|
|InputSetFOV|integer|0 \| 0x0|SetFOV|
|InputSetFOVBlendTime|float|0 \| 0x0|SetFOVBlendTime|
|InputSetLocalAngles|string|0 \| 0x0|SetLocalAngles|
|InputSetLocalOrigin|string|0 \| 0x0|SetLocalOrigin|
|InputSetNextBlendMode|integer|0 \| 0x0|SetNextBlendMode|
|InputSetNextBlendTime|float|0 \| 0x0|SetNextBlendTime|
|InputSetNextFOV|integer|0 \| 0x0|SetNextFOV|
...
|m_vecPlayerView|vector|860 \| 0x35c||
|m_vecPlayerViewAngles|vector|872 \| 0x368||
|m_vecCameraView|vector|884 \| 0x374||
|m_vecCameraViewAngles|vector|896 \| 0x380||
|m_iBlendMode|integer|908 \| 0x38c||
|m_iNextBlendMode|integer|912 \| 0x390||
|m_flNextBlendTime|time|916 \| 0x394||
|m_flBlendStartTime|time|920 \| 0x398||
|m_iStartFOV|integer|924 \| 0x39c||
|m_bActive|boolean|928 \| 0x3a0||
|m_iNextFOV|integer|932 \| 0x3a4||
|m_flNextFOVBlendTime|time|936 \| 0x3a8||
|m_flFOVBlendStartTime|time|940 \| 0x3ac||
|m_iFOV|integer|944 \| 0x3b0||
|m_bAlternateFOV|boolean|948 \| 0x3b4|alternatefovchange|
|m_flFadeColor|float|952 \| 0x3b8||
|m_flFadeAlpha|float|964 \| 0x3c4||
|m_flFadeDuration|float|968 \| 0x3c8||
|m_hCameraEntity|ehandle|972 \| 0x3cc||
|m_iQueuedBlendMode|integer|976 \| 0x3d0||
|m_iQueuedNextBlendMode|integer|980 \| 0x3d4||
