...
|m_vecMoveAng|vector|860 \| 0x35c||
|m_flFanFriction|float|872 \| 0x368||
|m_flAttenuation|float|876 \| 0x36c||
|m_flVolume|float|880 \| 0x370||
|m_flTargetSpeed|float|884 \| 0x374||
|m_flMaxSpeed|float|888 \| 0x378|maxspeed|
|m_flBlockDamage|float|892 \| 0x37c|dmg|
|m_NoiseRunning|soundname|896 \| 0x380|message|
|m_bReversed|boolean|900 \| 0x384||
|m_angStart|vector|904 \| 0x388||
|m_bStopAtStartPos|boolean|916 \| 0x394||
|m_bSolidBsp|boolean|917 \| 0x395|solidbsp|
|m_OnGetSpeed|custom|920 \| 0x398|OnGetSpeed|
