...
|CPointPlayerMoveConstraintConstraintThink|void|0 \| 0x0||
...
|m_flRadius|float|860 \| 0x35c|radius|
|m_flConstraintWidth|float|864 \| 0x360|width|
|m_flSpeedFactor|float|868 \| 0x364|speedfactor|
|m_hConstrainedPlayers|custom|876 \| 0x36c||
|m_OnConstraintBroken|custom|896 \| 0x380|OnConstraintBroken|
