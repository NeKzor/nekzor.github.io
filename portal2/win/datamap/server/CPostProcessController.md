...
|InputSetDepthBlurFocalDistance|float|0 \| 0x0|SetDepthBlurFocalDistance|
|InputSetDepthBlurStrength|float|0 \| 0x0|SetDepthBlurStrength|
|InputSetFadeTime|float|0 \| 0x0|SetFadeTime|
|InputSetFadeToBlackStrength|float|0 \| 0x0|SetFadeToBlackStrength|
|InputSetFilmGrainStrength|float|0 \| 0x0|SetFilmGrainStrength|
|InputSetLocalAngles|string|0 \| 0x0|SetLocalAngles|
|InputSetLocalContrastEdgeStrength|float|0 \| 0x0|SetLocalContrastEdgeStrength|
|InputSetLocalContrastStrength|float|0 \| 0x0|SetLocalContrastStrength|
...
|InputSetScreenBlurStrength|float|0 \| 0x0|SetScreenBlurStrength|
|InputSetTeam|integer|0 \| 0x0|SetTeam|
|InputSetVignetteBlurStrength|float|0 \| 0x0|SetVignetteBlurStrength|
|InputSetVignetteEnd|float|0 \| 0x0|SetVignetteEnd|
|InputSetVignetteStart|float|0 \| 0x0|SetVignetteStart|
...
|m_flPostProcessParameters[ PPPN_FADE_TIME ]|float|860 \| 0x35c|fadetime|
|m_flPostProcessParameters[ PPPN_LOCAL_CONTRAST_STRENGTH ]|float|864 \| 0x360|localcontraststrength|
|m_flPostProcessParameters[ PPPN_LOCAL_CONTRAST_EDGE_STRENGTH ]|float|868 \| 0x364|localcontrastedgestrength|
|m_flPostProcessParameters[ PPPN_VIGNETTE_START ]|time|872 \| 0x368|vignettestart|
|m_flPostProcessParameters[ PPPN_VIGNETTE_END ]|time|876 \| 0x36c|vignetteend|
|m_flPostProcessParameters[ PPPN_VIGNETTE_BLUR_STRENGTH ]|float|880 \| 0x370|vignetteblurstrength|
|m_flPostProcessParameters[ PPPN_FADE_TO_BLACK_STRENGTH ]|float|884 \| 0x374|fadetoblackstrength|
|m_flPostProcessParameters[ PPPN_DEPTH_BLUR_FOCAL_DISTANCE ]|float|888 \| 0x378|depthblurfocaldistance|
|m_flPostProcessParameters[ PPPN_DEPTH_BLUR_STRENGTH ]|float|892 \| 0x37c|depthblurstrength|
|m_flPostProcessParameters[ PPPN_SCREEN_BLUR_STRENGTH ]|float|896 \| 0x380|screenblurstrength|
|m_flPostProcessParameters[ PPPN_FILM_GRAIN_STRENGTH ]|float|900 \| 0x384|filmgrainstrength|
