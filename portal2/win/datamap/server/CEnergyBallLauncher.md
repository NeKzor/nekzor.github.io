...
|CFuncCombineBallSpawnerBallThink|void|0 \| 0x0||
|CFuncCombineBallSpawnerGrabBallTouch|void|0 \| 0x0||
...
|InputLaunchBall|void|0 \| 0x0|LaunchBall|
...
|m_flBallRadius|float|864 \| 0x360|ballradius|
|m_flBallRespawnTime|float|868 \| 0x364|ballrespawntime|
|m_flMinSpeed|float|872 \| 0x368|minspeed|
|m_flMaxSpeed|float|876 \| 0x36c|maxspeed|
|m_BallRespawnTime|custom|880 \| 0x370||
|m_nBallCount|integer|900 \| 0x384|ballcount|
|m_nBallsRemainingInField|integer|904 \| 0x388||
|m_flRadius|float|908 \| 0x38c||
|m_flDisableTime|time|912 \| 0x390||
|m_bEnabled|boolean|916 \| 0x394||
|m_OnBallGrabbed|custom|920 \| 0x398|OnBallGrabbed|
|m_OnBallReinserted|custom|944 \| 0x3b0|OnBallReinserted|
|m_OnBallHitTopSide|custom|968 \| 0x3c8|OnBallHitTopSide|
|m_OnBallHitBottomSide|custom|992 \| 0x3e0|OnBallHitBottomSide|
|m_OnLastBallGrabbed|custom|1016 \| 0x3f8|OnLastBallGrabbed|
|m_OnFirstBallReinserted|custom|1040 \| 0x410|OnFirstBallReinserted|
|m_iBounces|integer|1064 \| 0x428|maxballbounces|
|m_flConeDegrees|float|1068 \| 0x42c|launchconenoise|
|m_iszBullseyeName|string|1072 \| 0x430|bullseyename|
|m_fBallLifetime|float|1076 \| 0x434|BallLifetime|
|m_fMinBallLifeAfterPortal|float|1080 \| 0x438|MinLifeAfterPortal|
|m_OnPostSpawnBall|custom|1084 \| 0x43c|OnPostSpawnBall|
|m_OnBallCaught|custom|1108 \| 0x454|OnBallCaught|
