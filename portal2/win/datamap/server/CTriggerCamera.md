...
|CTriggerCameraFollowTarget|void|0 \| 0x0||
|CTriggerCameraReturnToEyes|void|0 \| 0x0||
...
|InputReturnToEyes|void|0 \| 0x0|ReturnToEyes|
...
|InputSetPath|string|0 \| 0x0|SetPath|
|InputSetTarget|string|0 \| 0x0|SetTarget|
|InputSetTargetAttachment|string|0 \| 0x0|SetTargetAttachment|
|InputSetTeam|integer|0 \| 0x0|SetTeam|
|InputSetTrackSpeed|float|0 \| 0x0|SetTrackSpeed|
|InputTeleportToView|void|0 \| 0x0|TeleportToView|
...
|m_hPlayer|ehandle|860 \| 0x35c||
|m_hTarget|ehandle|864 \| 0x360||
|m_pPath|classptr|868 \| 0x364||
|m_sPath|string|872 \| 0x368||
|m_flWait|float|876 \| 0x36c||
|m_flReturnTime|time|880 \| 0x370||
|m_flStopTime|time|884 \| 0x374||
|m_moveDistance|float|888 \| 0x378||
|m_targetSpeed|float|892 \| 0x37c||
|m_initialSpeed|float|896 \| 0x380||
|m_acceleration|float|900 \| 0x384||
|m_deceleration|float|904 \| 0x388||
|m_state|integer|908 \| 0x38c||
|m_vecMoveDir|vector|912 \| 0x390||
|m_fov|float|924 \| 0x39c|fov|
|m_fovSpeed|float|928 \| 0x3a0|fov_rate|
|m_trackSpeed|float|932 \| 0x3a4|trackspeed|
|m_iszTargetAttachment|string|936 \| 0x3a8|targetattachment|
|m_iAttachmentIndex|integer|940 \| 0x3ac||
|m_bSnapToGoal|boolean|944 \| 0x3b0||
|m_nPlayerButtons|integer|948 \| 0x3b4||
|m_nOldTakeDamage|integer|952 \| 0x3b8||
|m_OnEndFollow|custom|956 \| 0x3bc|OnEndFollow|
