...
|m_SourceEntityName|string|860 \| 0x35c|m_SourceEntityName|
|m_SoundName|string|864 \| 0x360|m_SoundName|
|m_Color|color32|868 \| 0x364|m_Color|
|m_NumBeams[0]|integer|872 \| 0x368|beamcount_min|
|m_NumBeams[1]|integer|876 \| 0x36c|beamcount_max|
|m_flRadius|float|880 \| 0x370|m_flRadius|
|m_flThickness[0]|float|884 \| 0x374|thick_min|
|m_flThickness[1]|float|888 \| 0x378|thick_max|
|m_flTimeVisible[0]|float|892 \| 0x37c|lifetime_min|
|m_flTimeVisible[1]|float|896 \| 0x380|lifetime_max|
|m_flArcInterval[0]|float|900 \| 0x384|interval_min|
|m_flArcInterval[1]|float|904 \| 0x388|interval_max|
|m_bOn|boolean|908 \| 0x38c|m_bOn|
|m_iszSpriteName|string|912 \| 0x390|texture|
