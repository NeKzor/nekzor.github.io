...
|m_ppath|classptr|860 \| 0x35c||
|m_length|float|864 \| 0x360|wheels|
|m_controlMins|vector|868 \| 0x364||
|m_controlMaxs|vector|880 \| 0x370||
|m_flVolume|float|908 \| 0x38c||
|m_flBank|float|912 \| 0x390|bank|
|m_oldSpeed|float|916 \| 0x394||
|m_flBlockDamage|float|920 \| 0x398|dmg|
|m_height|float|924 \| 0x39c|height|
|m_maxSpeed|float|928 \| 0x3a0|startspeed|
|m_dir|float|932 \| 0x3a4||
|m_iszSoundMove|soundname|936 \| 0x3a8|MoveSound|
|m_iszSoundMovePing|soundname|940 \| 0x3ac|MovePingSound|
|m_iszSoundStart|soundname|944 \| 0x3b0|StartSound|
|m_iszSoundStop|soundname|948 \| 0x3b4|StopSound|
|m_strPathTarget|string|952 \| 0x3b8||
|m_flMoveSoundMinTime|float|956 \| 0x3bc|MoveSoundMinTime|
|m_flMoveSoundMaxTime|float|960 \| 0x3c0|MoveSoundMaxTime|
|m_flNextMoveSoundTime|time|964 \| 0x3c4||
|m_nMoveSoundMinPitch|integer|968 \| 0x3c8|MoveSoundMinPitch|
|m_nMoveSoundMaxPitch|integer|972 \| 0x3cc|MoveSoundMaxPitch|
|m_eOrientationType|integer|976 \| 0x3d0|orientationtype|
|m_eVelocityType|integer|980 \| 0x3d4|velocitytype|
|m_bSoundPlaying|boolean|984 \| 0x3d8||
|m_OnStart|custom|988 \| 0x3dc|OnStart|
|m_OnNext|custom|1012 \| 0x3f4|OnNextPoint|
|m_OnArrivedAtDestinationNode|custom|1036 \| 0x40c|OnArrivedAtDestinationNode|
|m_bManualSpeedChanges|boolean|1060 \| 0x424|ManualSpeedChanges|
|m_flAccelSpeed|float|1072 \| 0x430|ManualAccelSpeed|
|m_flDecelSpeed|float|1076 \| 0x434|ManualDecelSpeed|
|m_OnDeath|custom|1088 \| 0x440|OnDeath|
