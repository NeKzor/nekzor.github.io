...
|CBaseNPCMakerMakerThink|void|0 \| 0x0||
|InputAddContext|string|0 \| 0x0|AddContext|
|InputAddMaxChildren|integer|0 \| 0x0|AddMaxChildren|
...
|InputSetMaxChildren|integer|0 \| 0x0|SetMaxChildren|
|InputSetMaxLiveChildren|integer|0 \| 0x0|SetMaxLiveChildren|
...
|InputSetSpawnFrequency|float|0 \| 0x0|SetSpawnFrequency|
|InputSetTeam|integer|0 \| 0x0|SetTeam|
|InputSpawnNPC|void|0 \| 0x0|Spawn|
...
|m_nMaxNumNPCs|integer|860 \| 0x35c|MaxNPCCount|
|m_flSpawnFrequency|float|864 \| 0x360|SpawnFrequency|
|m_nHullCheckMode|integer|868 \| 0x364|HullCheckMode|
|m_OnSpawnNPC|custom|872 \| 0x368|OnSpawnNPC|
|m_OnAllSpawned|custom|896 \| 0x380|OnAllSpawned|
|m_OnAllSpawnedDead|custom|920 \| 0x398|OnAllSpawnedDead|
|m_OnAllLiveChildrenDead|custom|944 \| 0x3b0|OnAllLiveChildrenDead|
|m_nLiveChildren|integer|968 \| 0x3c8||
|m_nMaxLiveChildren|integer|972 \| 0x3cc|MaxLiveChildren|
|m_bDisabled|boolean|976 \| 0x3d0|StartDisabled|
|m_hIgnoreEntity|ehandle|980 \| 0x3d4||
|m_iszIngoreEnt|string|984 \| 0x3d8|IgnoreEntity|
