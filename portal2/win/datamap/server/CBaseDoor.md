...
|m_ls.sLockedSound|soundname|996 \| 0x3e4|locked_sound|
|m_ls.sUnlockedSound|soundname|1004 \| 0x3ec|unlocked_sound|
|m_bLockedSentence|character|1032 \| 0x408||
|m_bUnlockedSentence|character|1033 \| 0x409||
|m_bForceClosed|boolean|1034 \| 0x40a|forceclosed|
|m_bDoorGroup|boolean|1035 \| 0x40b||
|m_bLocked|boolean|1036 \| 0x40c||
|m_bIgnoreDebris|boolean|1037 \| 0x40d|ignoredebris|
|m_eSpawnPosition|integer|1040 \| 0x410|spawnpos|
|m_flBlockDamage|float|1044 \| 0x414|dmg|
|m_NoiseMoving|soundname|1048 \| 0x418|noise1|
|m_NoiseArrived|soundname|1052 \| 0x41c|noise2|
|m_NoiseMovingClosed|soundname|1056 \| 0x420|startclosesound|
|m_NoiseArrivedClosed|soundname|1060 \| 0x424|closesound|
|m_ChainTarget|string|1064 \| 0x428|chainstodoor|
|m_flWaveHeight|float|1068 \| 0x42c|WaveHeight|
|m_OnBlockedClosing|custom|1072 \| 0x430|OnBlockedClosing|
|m_OnBlockedOpening|custom|1096 \| 0x448|OnBlockedOpening|
|m_OnUnblockedClosing|custom|1120 \| 0x460|OnUnblockedClosing|
|m_OnUnblockedOpening|custom|1144 \| 0x478|OnUnblockedOpening|
|m_OnFullyClosed|custom|1168 \| 0x490|OnFullyClosed|
|m_OnFullyOpen|custom|1192 \| 0x4a8|OnFullyOpen|
|m_OnClose|custom|1216 \| 0x4c0|OnClose|
|m_OnOpen|custom|1240 \| 0x4d8|OnOpen|
|m_OnLockedUse|custom|1264 \| 0x4f0|OnLockedUse|
|m_bLoopMoveSound|boolean|1288 \| 0x508|loopmovesound|
