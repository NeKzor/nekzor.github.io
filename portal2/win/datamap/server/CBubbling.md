...
|InputSetCurrent|integer|0 \| 0x0|SetCurrent|
|InputSetDamageFilter|string|0 \| 0x0|SetDamageFilter|
|InputSetDensity|integer|0 \| 0x0|SetDensity|
|InputSetFrequency|integer|0 \| 0x0|SetFrequency|
...
|m_flSpeed|float|520 \| 0x208|current|
...
|m_density|integer|860 \| 0x35c|density|
|m_frequency|integer|864 \| 0x360|frequency|
|m_state|integer|872 \| 0x368||
