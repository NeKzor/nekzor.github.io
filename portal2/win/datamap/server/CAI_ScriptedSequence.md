...
|m_iszEntry|string|860 \| 0x35c|m_iszEntry|
|m_iszPreIdle|string|864 \| 0x360|m_iszIdle|
|m_iszPlay|string|868 \| 0x364|m_iszPlay|
|m_iszPostIdle|string|872 \| 0x368|m_iszPostIdle|
|m_iszCustomMove|string|876 \| 0x36c|m_iszCustomMove|
|m_iszNextScript|string|880 \| 0x370|m_iszNextScript|
|m_iszEntity|string|884 \| 0x374|m_iszEntity|
|m_fMoveTo|integer|888 \| 0x378|m_fMoveTo|
|m_bIsPlayingEntry|boolean|892 \| 0x37c||
|m_bLoopActionSequence|boolean|893 \| 0x37d|m_bLoopActionSequence|
|m_bSynchPostIdles|boolean|894 \| 0x37e|m_bSynchPostIdles|
|m_bIgnoreGravity|boolean|895 \| 0x37f|m_bIgnoreGravity|
|m_bDisableNPCCollisions|boolean|896 \| 0x380|m_bDisableNPCCollisions|
|m_flRadius|float|900 \| 0x384|m_flRadius|
|m_flRepeat|float|904 \| 0x388|m_flRepeat|
|m_iDelay|integer|908 \| 0x38c||
|m_bDelayed|boolean|912 \| 0x390||
|m_startTime|time|916 \| 0x394||
|m_bWaitForBeginSequence|boolean|920 \| 0x398||
|m_saved_effects|integer|924 \| 0x39c||
|m_savedFlags|integer|928 \| 0x3a0||
|m_savedCollisionGroup|integer|932 \| 0x3a4||
|m_interruptable|boolean|936 \| 0x3a8||
|m_sequenceStarted|boolean|937 \| 0x3a9||
|m_hTargetEnt|ehandle|940 \| 0x3ac||
|m_hNextCine|ehandle|944 \| 0x3b0||
|m_bThinking|boolean|948 \| 0x3b4||
|m_bInitiatedSelfDelete|boolean|949 \| 0x3b5||
|m_bIsTeleportingDueToMoveTo|boolean|950 \| 0x3b6||
|m_hLastFoundEntity|ehandle|952 \| 0x3b8||
|m_hForcedTarget|ehandle|956 \| 0x3bc||
|m_bDontCancelOtherSequences|boolean|960 \| 0x3c0||
|m_bForceSynch|boolean|961 \| 0x3c1||
|m_bTargetWasAsleep|boolean|962 \| 0x3c2||
|m_OnBeginSequence|custom|964 \| 0x3c4|OnBeginSequence|
|m_OnEndSequence|custom|988 \| 0x3dc|OnEndSequence|
|m_OnPostIdleEndSequence|custom|1012 \| 0x3f4|OnPostIdleEndSequence|
|m_OnCancelSequence|custom|1036 \| 0x40c|OnCancelSequence|
|m_OnCancelFailedSequence|custom|1060 \| 0x424|OnCancelFailedSequence|
|m_OnScriptEvent[0]|custom|1084 \| 0x43c|OnScriptEvent01|
|m_OnScriptEvent[1]|custom|1108 \| 0x454|OnScriptEvent02|
|m_OnScriptEvent[2]|custom|1132 \| 0x46c|OnScriptEvent03|
|m_OnScriptEvent[3]|custom|1156 \| 0x484|OnScriptEvent04|
|m_OnScriptEvent[4]|custom|1180 \| 0x49c|OnScriptEvent05|
|m_OnScriptEvent[5]|custom|1204 \| 0x4b4|OnScriptEvent06|
|m_OnScriptEvent[6]|custom|1228 \| 0x4cc|OnScriptEvent07|
|m_OnScriptEvent[7]|custom|1252 \| 0x4e4|OnScriptEvent08|
|m_matInteractionPosition|vmatrix|1276 \| 0x4fc||
|m_hInteractionRelativeEntity|ehandle|1340 \| 0x53c||
|m_iPlayerDeathBehavior|integer|1344 \| 0x540|onplayerdeath|
