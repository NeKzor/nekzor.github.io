...
|m_flHDRColorScale|float|864 \| 0x360|HDRColorScale|
|m_flFireTime|time|868 \| 0x364||
|m_flDamage|float|872 \| 0x368|damage|
|m_nNumBeamEnts|integer|876 \| 0x36c||
|m_nHaloIndex|modelindex|880 \| 0x370||
|m_nBeamType|integer|884 \| 0x374||
|m_nBeamFlags|integer|888 \| 0x378||
|m_hAttachEntity|ehandle|892 \| 0x37c||
|m_nAttachIndex|integer|932 \| 0x3a4||
...
|m_fSpeed|float|996 \| 0x3e4|ScrollSpeed|
|m_fSpeed|float|996 \| 0x3e4||
|m_flFrame|float|1000 \| 0x3e8||
|m_nClipStyle|integer|1004 \| 0x3ec|ClipStyle|
|m_vecEndPos|pos-vector|1008 \| 0x3f0||
|m_hEndEntity|ehandle|1020 \| 0x3fc||
|m_nDissolveType|integer|1024 \| 0x400|dissolvetype|
|m_active|integer|1028 \| 0x404||
|m_spriteTexture|integer|1032 \| 0x408||
|m_iszStartEntity|string|1036 \| 0x40c|LightningStart|
|m_iszEndEntity|string|1040 \| 0x410|LightningEnd|
|m_life|float|1044 \| 0x414|life|
|m_boltWidth|float|1048 \| 0x418|BoltWidth|
|m_noiseAmplitude|float|1052 \| 0x41c|NoiseAmplitude|
|m_speed|integer|1056 \| 0x420|TextureScroll|
|m_restrike|float|1060 \| 0x424|StrikeTime|
|m_iszSpriteName|string|1064 \| 0x428|texture|
|m_frameStart|integer|1068 \| 0x42c|framestart|
|m_vEndPointWorld|vector|1072 \| 0x430|targetpoint|
|m_radius|float|1096 \| 0x448|Radius|
|m_TouchType|integer|1100 \| 0x44c|TouchType|
|m_iFilterName|string|1104 \| 0x450|filtername|
|m_hFilter|ehandle|1108 \| 0x454||
|m_iszDecal|string|1112 \| 0x458|decalname|
|m_OnTouchedByEntity|custom|1116 \| 0x45c|OnTouchedByEntity|
