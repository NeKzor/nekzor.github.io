...
|m_iMinBurstSize|integer|860 \| 0x35c|minburstsize|
|m_iMaxBurstSize|integer|864 \| 0x360|maxburstsize|
|m_flMinBurstDelay|time|868 \| 0x364|minburstdelay|
|m_flMaxBurstDelay|time|872 \| 0x368|maxburstdelay|
|m_flRateOfFire|float|876 \| 0x36c|rateoffire|
|m_iszShootSound|string|880 \| 0x370|shootsound|
|m_iszTracerType|string|884 \| 0x374|tracertype|
|m_bDisabled|boolean|888 \| 0x378|startdisabled|
|m_iShotsRemaining|integer|892 \| 0x37c||
|m_iSpread|integer|896 \| 0x380|spread|
|m_vecSpread|vector|900 \| 0x384||
|m_vecTargetPosition|vector|912 \| 0x390||
|m_flTargetDist|float|924 \| 0x39c||
|m_flBias|float|928 \| 0x3a0|bias|
|m_bCollide|boolean|932 \| 0x3a4|collisions|
|m_hTarget|ehandle|936 \| 0x3a8||
