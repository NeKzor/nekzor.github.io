...
|m_iGibs|integer|860 \| 0x35c|m_iGibs|
|m_iGibCapacity|integer|864 \| 0x360||
|m_iGibMaterial|integer|868 \| 0x364||
|m_iGibModelIndex|integer|872 \| 0x368||
|m_flGibVelocity|float|876 \| 0x36c|m_flVelocity|
|m_angGibRotation|vector|880 \| 0x370|gibangles|
|m_flGibAngVelocity|float|892 \| 0x37c|gibanglevelocity|
|m_flVariance|float|896 \| 0x380|m_flVariance|
|m_flGibLife|float|900 \| 0x384|m_flGibLife|
|m_nSimulationType|integer|904 \| 0x388|Simulation|
|m_nMaxGibModelFrame|integer|908 \| 0x38c||
|m_flDelay|float|912 \| 0x390|delay|
|m_bNoGibShadows|boolean|916 \| 0x394|nogibshadows|
|m_bIsSprite|boolean|917 \| 0x395||
|m_iszLightingOrigin|string|920 \| 0x398|LightingOrigin|
