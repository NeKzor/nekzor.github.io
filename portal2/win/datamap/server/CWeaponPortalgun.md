...
|m_hOwner|ehandle|1200 \| 0x4b0||
|m_nViewModelIndex|integer|1204 \| 0x4b4||
|m_flNextPrimaryAttack|time|1208 \| 0x4b8||
|m_flNextSecondaryAttack|time|1212 \| 0x4bc||
|m_iState|integer|1224 \| 0x4c8||
|m_iPrimaryAmmoType|integer|1228 \| 0x4cc||
|m_iSecondaryAmmoType|integer|1232 \| 0x4d0||
|m_iClip1|integer|1236 \| 0x4d4||
|m_iClip2|integer|1240 \| 0x4d8||
|m_flTimeWeaponIdle|time|1244 \| 0x4dc||
|m_fMinRange1|float|1252 \| 0x4e4||
|m_fMinRange2|float|1256 \| 0x4e8||
|m_fMaxRange1|float|1260 \| 0x4ec||
|m_fMaxRange2|float|1264 \| 0x4f0||
|m_fFireDuration|float|1268 \| 0x4f4||
|m_iPrimaryAmmoCount|integer|1276 \| 0x4fc||
|m_iSecondaryAmmoCount|integer|1280 \| 0x500||
|m_iszName|string|1284 \| 0x504||
|m_bRemoveable|boolean|1288 \| 0x508||
|m_bInReload|boolean|1289 \| 0x509||
|m_bFireOnEmpty|boolean|1290 \| 0x50a||
|m_bFiresUnderwater|boolean|1291 \| 0x50b||
|m_bAltFiresUnderwater|boolean|1292 \| 0x50c||
|m_bReloadsSingly|boolean|1293 \| 0x50d||
|m_nIdealSequence|integer|1296 \| 0x510||
|m_IdealActivity|integer|1300 \| 0x514||
|m_iSubType|integer|1304 \| 0x518||
|m_flUnlockTime|time|1308 \| 0x51c||
|m_hLocker|ehandle|1312 \| 0x520||
|m_pConstraint|custom|1320 \| 0x528||
|m_iAltFireHudHintCount|integer|1324 \| 0x52c||
|m_iReloadHudHintCount|integer|1328 \| 0x530||
|m_bAltFireHudHintDisplayed|boolean|1332 \| 0x534||
|m_bReloadHudHintDisplayed|boolean|1333 \| 0x535||
|m_flHudHintPollTime|time|1336 \| 0x538||
|m_flHudHintMinDisplayTime|time|1340 \| 0x53c||
|m_OnPlayerUse|custom|1344 \| 0x540|OnPlayerUse|
|m_OnPlayerPickup|custom|1368 \| 0x558|OnPlayerPickup|
|m_OnNPCPickup|custom|1392 \| 0x570|OnNPCPickup|
|m_OnCacheInteraction|custom|1416 \| 0x588|OnCacheInteraction|
|m_bLowered|boolean|1472 \| 0x5c0||
|m_flRaiseTime|time|1476 \| 0x5c4||
|m_flHolsterTime|time|1480 \| 0x5c8||
|m_flNextRepeatPrimaryAttack|time|1484 \| 0x5cc||
|m_flNextRepeatSecondaryAttack|time|1488 \| 0x5d0||
|m_bCanFirePortal1|boolean|1500 \| 0x5dc|CanFirePortal1|
|m_bCanFirePortal2|boolean|1501 \| 0x5dd|CanFirePortal2|
|m_iLastFiredPortal|integer|1504 \| 0x5e0||
|m_bOpenProngs|boolean|1508 \| 0x5e4||
|m_vecBluePortalPos|vector|1512 \| 0x5e8||
|m_vecOrangePortalPos|vector|1524 \| 0x5f4||
|m_hFreezeEntity|ehandle|1536 \| 0x600||
|m_iPortalLinkageGroupID|character|1540 \| 0x604||
|m_fEffectsMaxSize1|float|1544 \| 0x608||
|m_fEffectsMaxSize2|float|1548 \| 0x60c||
|m_pMiniGravHoldSound|custom|1552 \| 0x610||
|m_OnFiredPortal1|custom|1556 \| 0x614|OnFiredPortal1|
|m_OnFiredPortal2|custom|1580 \| 0x62c|OnFiredPortal2|
|m_bShowingPotatos|boolean|1604 \| 0x644|ShowingPotatos|
|m_nStartingTeamNum|integer|1608 \| 0x648|StartingTeamNum|
|m_EffectState|integer|1612 \| 0x64c||
