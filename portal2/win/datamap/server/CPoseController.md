...
|CPoseControllerThink|void|0 \| 0x0||
...
|InputGetFMod|void|0 \| 0x0|GetFMod|
|InputKill|void|0 \| 0x0|Kill|
|InputKillHierarchy|void|0 \| 0x0|KillHierarchy|
|InputRandomizeFMod|float|0 \| 0x0|RandomizeFMod|
...
|InputSetCycleFrequency|float|0 \| 0x0|SetCycleFrequency|
|InputSetDamageFilter|string|0 \| 0x0|SetDamageFilter|
|InputSetFModAmplitude|float|0 \| 0x0|SetFModAmplitude|
|InputSetFModRate|float|0 \| 0x0|SetFModRate|
|InputSetFModTimeOffset|float|0 \| 0x0|SetFModTimeOffset|
|InputSetFModType|integer|0 \| 0x0|SetFModType|
|InputSetInterpolationTime|float|0 \| 0x0|SetInterpolationTime|
...
|InputSetPoseParameterName|string|0 \| 0x0|SetPoseParameterName|
|InputSetPoseValue|float|0 \| 0x0|SetPoseValue|
...
|m_hProps|ehandle|860 \| 0x35c||
|m_chPoseIndex|character|876 \| 0x36c||
|m_bDisablePropLookup|boolean|880 \| 0x370||
|m_bPoseValueParity|boolean|881 \| 0x371||
|m_iszPropName|string|884 \| 0x374|PropName|
|m_iszPoseParameterName|string|888 \| 0x378|PoseParameterName|
|m_fPoseValue|float|892 \| 0x37c|PoseValue|
|m_fInterpolationTime|float|896 \| 0x380|InterpolationTime|
|m_bInterpolationWrap|boolean|900 \| 0x384|InterpolationWrap|
|m_fCycleFrequency|float|904 \| 0x388|CycleFrequency|
|m_nFModType|integer|908 \| 0x38c|FModType|
|m_fFModTimeOffset|float|912 \| 0x390|FModTimeOffset|
|m_fFModRate|float|916 \| 0x394|FModRate|
|m_fFModAmplitude|float|920 \| 0x398|FModAmplitude|
