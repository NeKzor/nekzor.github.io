...
|---|:-:|:-:|--:|
|CAI_ScriptedSentenceDelayThink|void|0 \| 0x0||
|CAI_ScriptedSentenceFindThink|void|0 \| 0x0||
...
|InputBeginSentence|void|0 \| 0x0|BeginSentence|
...
|m_iszSentence|string|860 \| 0x35c|sentence|
|m_iszEntity|string|864 \| 0x360|entity|
|m_flRadius|float|868 \| 0x364|radius|
|m_flDelay|float|872 \| 0x368|delay|
|m_flRepeat|float|876 \| 0x36c|refire|
|m_iSoundLevel|integer|880 \| 0x370||
|m_TempAttenuation|integer|884 \| 0x374|attenuation|
|m_flVolume|float|888 \| 0x378||
|m_active|boolean|892 \| 0x37c||
|m_iszListener|string|896 \| 0x380|listener|
|m_pActivator|ehandle|900 \| 0x384||
|m_OnBeginSentence|custom|904 \| 0x388|OnBeginSentence|
|m_OnEndSentence|custom|928 \| 0x3a0|OnEndSentence|
