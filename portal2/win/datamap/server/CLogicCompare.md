...
|m_flInValue|float|860 \| 0x35c|InitialValue|
|m_flCompareValue|float|864 \| 0x360|CompareValue|
|m_OnLessThan|custom|868 \| 0x364|OnLessThan|
|m_OnEqualTo|custom|892 \| 0x37c|OnEqualTo|
|m_OnNotEqualTo|custom|916 \| 0x394|OnNotEqualTo|
|m_OnGreaterThan|custom|940 \| 0x3ac|OnGreaterThan|
