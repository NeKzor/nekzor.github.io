...
|InputDivide|float|0 \| 0x0|Divide|
...
|InputSetHitMax|float|0 \| 0x0|SetHitMax|
|InputSetHitMin|float|0 \| 0x0|SetHitMin|
|InputSetLocalAngles|string|0 \| 0x0|SetLocalAngles|
|InputSetLocalOrigin|string|0 \| 0x0|SetLocalOrigin|
|InputSetMaxValueNoFire|float|0 \| 0x0|SetMaxValueNoFire|
|InputSetMinValueNoFire|float|0 \| 0x0|SetMinValueNoFire|
...
|InputSetValueNoFire|float|0 \| 0x0|SetValueNoFire|
|InputSubtract|float|0 \| 0x0|Subtract|
...
|m_flMin|float|860 \| 0x35c|min|
|m_flMax|float|864 \| 0x360|max|
|m_bHitMin|boolean|868 \| 0x364||
|m_bHitMax|boolean|869 \| 0x365||
|m_bDisabled|boolean|870 \| 0x366|StartDisabled|
|m_OutValue|custom|872 \| 0x368|OutValue|
|m_OnGetValue|custom|896 \| 0x380|OnGetValue|
|m_OnHitMin|custom|920 \| 0x398|OnHitMin|
|m_OnHitMax|custom|944 \| 0x3b0|OnHitMax|
|m_OnChangedFromMin|custom|968 \| 0x3c8|OnChangedFromMin|
|m_OnChangedFromMax|custom|992 \| 0x3e0|OnChangedFromMax|
