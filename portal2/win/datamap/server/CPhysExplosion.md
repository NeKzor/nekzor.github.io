...
|InputExplodeAndRemove|void|0 \| 0x0|ExplodeAndRemove|
...
|m_damage|float|860 \| 0x35c|magnitude|
|m_radius|float|864 \| 0x360|radius|
|m_targetEntityName|string|868 \| 0x364|targetentityname|
|m_flInnerRadius|float|872 \| 0x368|inner_radius|
|m_OnPushedPlayer|custom|876 \| 0x36c|OnPushedPlayer|
