...
|m_Amplitude|float|860 \| 0x35c|amplitude|
|m_Frequency|float|864 \| 0x360|frequency|
|m_Duration|float|868 \| 0x364|duration|
|m_Radius|float|872 \| 0x368|radius|
|m_stopTime|time|876 \| 0x36c||
|m_nextShake|time|880 \| 0x370||
|m_currentAmp|float|884 \| 0x374||
|m_maxForce|vector|888 \| 0x378||
|m_pShakeController|custom|900 \| 0x384||
|m_shakeCallback|[CPhysicsShake](#cphysicsshake)|904 \| 0x388||
