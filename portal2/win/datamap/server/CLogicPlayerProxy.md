...
|InputAddPotatosToPortalgun|void|0 \| 0x0|AddPotatosToPortalgun|
...
|InputForcePhysicsGrabController|void|0 \| 0x0|ForcePhysicsGrabController|
|InputForceVMGrabController|void|0 \| 0x0|ForceVMGrabController|
|InputKill|void|0 \| 0x0|Kill|
|InputKillHierarchy|void|0 \| 0x0|KillHierarchy|
|InputPaintPlayerWithPortalPaint|void|0 \| 0x0|PaintPlayerWithPortalPaint|
|InputRemoveContext|string|0 \| 0x0|RemoveContext|
|InputRemovePaint|void|0 \| 0x0|RemovePaint|
|InputRemovePotatosFromPortalgun|void|0 \| 0x0|RemovePotatosFromPortalgun|
|InputResetGrabControllerBehavior|void|0 \| 0x0|ResetGrabControllerBehavior|
...
|InputSetDropEnabled|boolean|0 \| 0x0|SetDropEnabled|
|InputSetLocalAngles|string|0 \| 0x0|SetLocalAngles|
|InputSetLocalOrigin|string|0 \| 0x0|SetLocalOrigin|
|InputSetMotionBlurAmount|float|0 \| 0x0|SetMotionBlurAmount|
...
|m_OnStartSlowingTime|custom|860 \| 0x35c|OnStartSlowingTime|
|m_OnStopSlowingTime|custom|884 \| 0x374|OnStopSlowingTime|
|m_OnCoopPing|custom|908 \| 0x38c|OnCoopPing|
|m_OnPrimaryPortalPlaced|custom|932 \| 0x3a4|OnPrimaryPortalPlaced|
|m_OnSecondaryPortalPlaced|custom|956 \| 0x3bc|OnSecondaryPortalPlaced|
|m_PlayerDied|custom|1028 \| 0x404|PlayerDied|
|m_OnDuck|custom|1052 \| 0x41c|OnDuck|
|m_OnUnDuck|custom|1076 \| 0x434|OnUnDuck|
|m_OnJump|custom|1100 \| 0x44c|OnJump|
|m_RequestedPlayerHealth|custom|1124 \| 0x464|PlayerHealth|
|m_hPlayer|ehandle|1148 \| 0x47c||
