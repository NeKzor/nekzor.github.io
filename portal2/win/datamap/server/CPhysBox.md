...
|m_damageType|integer|1036 \| 0x40c|Damagetype|
|m_massScale|float|1040 \| 0x410|massScale|
|m_iszOverrideScript|string|1044 \| 0x414|overridescript|
|m_damageToEnableMotion|integer|1048 \| 0x418|damagetoenablemotion|
|m_flForceToEnableMotion|float|1052 \| 0x41c|forcetoenablemotion|
|m_angPreferredCarryAngles|vector|1056 \| 0x420|preferredcarryangles|
|m_bNotSolidToWorld|boolean|1068 \| 0x42c|notsolid|
|m_iExploitableByPlayer|integer|1072 \| 0x430|ExploitableByPlayer|
|m_OnDamaged|custom|1076 \| 0x434|OnDamaged|
|m_OnAwakened|custom|1100 \| 0x44c|OnAwakened|
|m_OnMotionEnabled|custom|1124 \| 0x464|OnMotionEnabled|
|m_OnPhysGunPickup|custom|1148 \| 0x47c|OnPhysGunPickup|
|m_OnPhysGunPunt|custom|1172 \| 0x494|OnPhysGunPunt|
|m_OnPhysGunOnlyPickup|custom|1196 \| 0x4ac|OnPhysGunOnlyPickup|
|m_OnPhysGunDrop|custom|1220 \| 0x4c4|OnPhysGunDrop|
|m_OnPlayerUse|custom|1244 \| 0x4dc|OnPlayerUse|
|m_hCarryingPlayer|ehandle|1268 \| 0x4f4||
