...
|InputShootFutbol|void|0 \| 0x0|ShootFutbol|
...
|m_OutputShootSuccess|custom|860 \| 0x35c|OnShootSuccess|
|m_OutputShootFail|custom|884 \| 0x374|OnShootFail|
|m_flPhysicsSpeed|float|908 \| 0x38c|LaunchSpeed|
