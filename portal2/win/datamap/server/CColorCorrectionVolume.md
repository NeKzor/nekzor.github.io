...
|m_bEnabled|boolean|1160 \| 0x488|enabled|
|m_bStartDisabled|boolean|1161 \| 0x489|StartDisabled|
|m_Weight|float|1164 \| 0x48c||
|m_MaxWeight|float|1168 \| 0x490|maxweight|
|m_lookupFilename|character|1172 \| 0x494|filename|
|m_LastEnterWeight|float|1432 \| 0x598||
|m_LastEnterTime|float|1436 \| 0x59c||
|m_LastExitWeight|float|1440 \| 0x5a0||
|m_LastExitTime|float|1444 \| 0x5a4||
|m_FadeDuration|float|1448 \| 0x5a8|fadeDuration|
