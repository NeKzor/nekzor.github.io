...
|InputValue|float|0 \| 0x0|InValue|
...
|m_flInMin|float|860 \| 0x35c|in1|
|m_flInMax|float|864 \| 0x360|in2|
|m_flOut1|float|868 \| 0x364|out1|
|m_flOut2|float|872 \| 0x368|out2|
|m_bEnabled|boolean|876 \| 0x36c||
|m_OutValue|custom|880 \| 0x370|OutValue|
