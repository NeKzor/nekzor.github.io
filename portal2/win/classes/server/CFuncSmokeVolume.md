...
|m_Color1|int|860 \| 0x35c|
|m_Color2|int|864 \| 0x360|
|m_MaterialName|string|868 \| 0x364|
|m_ParticleDrawWidth|float|1128 \| 0x468|
|m_ParticleSpacingDistance|float|1132 \| 0x46c|
|m_DensityRampSpeed|float|1136 \| 0x470|
|m_RotationSpeed|float|1140 \| 0x474|
|m_MovementSpeed|float|1144 \| 0x478|
|m_Density|float|1148 \| 0x47c|
|m_maxDrawDistance|float|1152 \| 0x480|
