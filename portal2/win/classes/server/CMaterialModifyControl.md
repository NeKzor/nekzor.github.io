...
|m_szMaterialName|string|860 \| 0x35c|
|m_szMaterialVar|string|1115 \| 0x45b|
|m_szMaterialVarValue|string|1370 \| 0x55a|
|m_iFrameStart|int|1628 \| 0x65c|
|m_iFrameEnd|int|1632 \| 0x660|
|m_bWrap|int|1636 \| 0x664|
|m_flFramerate|float|1640 \| 0x668|
|m_bNewAnimCommandsSemaphore|int|1644 \| 0x66c|
|m_flFloatLerpStartValue|float|1648 \| 0x670|
|m_flFloatLerpEndValue|float|1652 \| 0x674|
|m_flFloatLerpTransitionTime|float|1656 \| 0x678|
|m_nModifyMode|int|1660 \| 0x67c|
