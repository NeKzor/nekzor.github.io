...
|m_flWaveHeight|float|864 \| 0x360|
|m_WorldMins|vector|868 \| 0x364|
|m_WorldMaxs|vector|880 \| 0x370|
|m_flMaxOccludeeArea|float|892 \| 0x37c|
|m_flMinOccluderArea|float|896 \| 0x380|
|m_flMinPropScreenSpaceWidth|float|900 \| 0x384|
|m_flMaxPropScreenSpaceWidth|float|904 \| 0x388|
|m_iszDetailSpriteMaterial|string|908 \| 0x38c|
|m_bStartDark|int|912 \| 0x390|
|m_bColdWorld|int|913 \| 0x391|
|m_nMaxBlobCount|int|924 \| 0x39c|
