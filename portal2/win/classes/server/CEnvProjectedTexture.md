...
|m_hTargetEntity|int|860 \| 0x35c|
|m_bState|int|864 \| 0x360|
|m_bAlwaysUpdate|int|865 \| 0x361|
|m_flLightFOV|float|868 \| 0x364|
|m_bEnableShadows|int|872 \| 0x368|
|m_bSimpleProjection|int|873 \| 0x369|
|m_bLightOnlyTarget|int|874 \| 0x36a|
|m_bLightWorld|int|875 \| 0x36b|
|m_bCameraSpace|int|876 \| 0x36c|
|m_flBrightnessScale|float|880 \| 0x370|
|m_LightColor|int|884 \| 0x374|
|m_flColorTransitionTime|float|888 \| 0x378|
|m_flAmbient|float|892 \| 0x37c|
|m_SpotlightTextureName|string|896 \| 0x380|
|m_nSpotlightTextureFrame|int|1156 \| 0x484|
|m_flNearZ|float|1160 \| 0x488|
|m_flFarZ|float|1164 \| 0x48c|
|m_nShadowQuality|int|1168 \| 0x490|
|m_flProjectionSize|float|1172 \| 0x494|
|m_flRotation|float|1176 \| 0x498|
|m_iStyle|int|1180 \| 0x49c|
