...
|Prop|Type|Offset|
|---|:-:|:-:|
|baseclass|[DT_DynamicProp](#DT_DynamicProp)|0 \| 0x0|
|m_hPlayer|int|1664 \| 0x680|
|m_vehicleView.bClampEyeAngles|int|1672 \| 0x688|
|m_vehicleView.flPitchCurveZero|float|1676 \| 0x68c|
|m_vehicleView.flPitchCurveLinear|float|1680 \| 0x690|
|m_vehicleView.flRollCurveZero|float|1684 \| 0x694|
|m_vehicleView.flRollCurveLinear|float|1688 \| 0x698|
|m_vehicleView.flFOV|float|1692 \| 0x69c|
|m_vehicleView.flYawMin|float|1696 \| 0x6a0|
|m_vehicleView.flYawMax|float|1700 \| 0x6a4|
|m_vehicleView.flPitchMin|float|1704 \| 0x6a8|
|m_vehicleView.flPitchMax|float|1708 \| 0x6ac|
|m_bEnterAnimOn|int|2181 \| 0x885|
|m_bExitAnimOn|int|2182 \| 0x886|
|m_vecEyeExitEndpoint|vector|2184 \| 0x888|
|m_bForceEyesToAttachment|int|2200 \| 0x898|
...
|m_bUseHitboxesForRenderBox|int|1632 \| 0x660|
...
|m_qPreferredPlayerCarryAngles|vector|1532 \| 0x5fc|
|m_bClientPhysics|int|1544 \| 0x608|
