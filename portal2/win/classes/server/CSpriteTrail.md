...
|m_flLifeTime|float|940 \| 0x3ac|
|m_flStartWidth|float|944 \| 0x3b0|
|m_flEndWidth|float|948 \| 0x3b4|
|m_flStartWidthVariance|float|952 \| 0x3b8|
|m_flTextureRes|float|956 \| 0x3bc|
|m_flMinFadeLength|float|960 \| 0x3c0|
|m_vecSkyboxOrigin|vector|964 \| 0x3c4|
|m_flSkyboxScale|float|976 \| 0x3d0|
...
|m_hAttachedToEntity|int|860 \| 0x35c|
|m_nAttachment|int|864 \| 0x360|
|m_flSpriteFramerate|float|868 \| 0x364|
|m_flFrame|float|872 \| 0x368|
|m_nBrightness|int|880 \| 0x370|
|m_flBrightnessTime|float|884 \| 0x374|
|m_flSpriteScale|float|888 \| 0x378|
|m_flScaleTime|float|892 \| 0x37c|
|m_bWorldSpaceScale|int|896 \| 0x380|
|m_flGlowProxySize|float|900 \| 0x384|
|m_flHDRColorScale|float|904 \| 0x388|
