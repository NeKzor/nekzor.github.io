...
|m_StartColor|vector|860 \| 0x35c|
|m_EndColor|vector|872 \| 0x368|
|m_Opacity|float|884 \| 0x374|
|m_SpawnRate|float|888 \| 0x378|
|m_ParticleLifetime|float|892 \| 0x37c|
|m_StopEmitTime|float|896 \| 0x380|
|m_MinSpeed|float|900 \| 0x384|
|m_MaxSpeed|float|904 \| 0x388|
|m_StartSize|float|908 \| 0x38c|
|m_EndSize|float|912 \| 0x390|
|m_SpawnRadius|float|916 \| 0x394|
|m_MinDirectedSpeed|float|920 \| 0x398|
|m_MaxDirectedSpeed|float|924 \| 0x39c|
|m_bEmit|int|928 \| 0x3a0|
|m_nAttachment|int|932 \| 0x3a4|
