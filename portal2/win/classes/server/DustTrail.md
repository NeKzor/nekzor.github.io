...
|m_Color|vector|860 \| 0x35c|
|m_Opacity|float|872 \| 0x368|
|m_SpawnRate|float|876 \| 0x36c|
|m_ParticleLifetime|float|880 \| 0x370|
|m_StopEmitTime|float|884 \| 0x374|
|m_MinSpeed|float|888 \| 0x378|
|m_MaxSpeed|float|892 \| 0x37c|
|m_StartSize|float|896 \| 0x380|
|m_EndSize|float|900 \| 0x384|
|m_SpawnRadius|float|904 \| 0x388|
|m_MinDirectedSpeed|float|908 \| 0x38c|
|m_MaxDirectedSpeed|float|912 \| 0x390|
|m_bEmit|int|916 \| 0x394|
