...
|m_bPitchReorientation|int|7240 \| 0x1c48|
|m_hPortalEnvironment|int|7256 \| 0x1c58|
|m_PortalLocal|[DT_PortalLocal](#DT_PortalLocal)|7272 \| 0x1c68|
|m_flMotionBlurAmount|float|7720 \| 0x1e28|
|m_angEyeAngles[0]|float|7732 \| 0x1e34|
|m_angEyeAngles[1]|float|7736 \| 0x1e38|
|m_flHullHeight|float|7808 \| 0x1e80|
|m_hRagdoll|int|7920 \| 0x1ef0|
|m_iSpawnInterpCounter|int|8000 \| 0x1f40|
|m_iPlayerSoundType|int|8008 \| 0x1f48|
|m_bHeldObjectOnOppositeSideOfPortal|int|8012 \| 0x1f4c|
|m_hHeldObjectPortal|int|8016 \| 0x1f50|
|m_bIsHoldingSomething|int|8148 \| 0x1fd4|
|m_bPingDisabled|int|8192 \| 0x2000|
|m_bTauntDisabled|int|8193 \| 0x2001|
|m_bTauntRemoteView|int|8194 \| 0x2002|
|m_vecRemoteViewOrigin|vector|8196 \| 0x2004|
|m_vecRemoteViewAngles|vector|8208 \| 0x2010|
|m_fTauntCameraDistance|float|8220 \| 0x201c|
|m_nTeamTauntState|int|8232 \| 0x2028|
|m_vTauntPosition|vector|8236 \| 0x202c|
|m_vTauntAngles|vector|8248 \| 0x2038|
|m_vPreTauntAngles|vector|8260 \| 0x2044|
|m_bTrickFire|int|8272 \| 0x2050|
|m_hTauntPartnerInRange|int|8276 \| 0x2054|
|m_szTauntForce|string|8280 \| 0x2058|
|m_bUseVMGrab|int|8401 \| 0x20d1|
|m_bUsingVMGrabState|int|8402 \| 0x20d2|
|m_hAttachedObject|int|8404 \| 0x20d4|
|m_iSpawnCounter|int|8888 \| 0x22b8|
|m_bWantsToSwapGuns|int|9073 \| 0x2371|
|m_bPotatos|int|9074 \| 0x2372|
|m_Shared|[DT_PortalPlayerShared](#DT_PortalPlayerShared)|9092 \| 0x2384|
|m_StatsThisLevel|[DT_PortalPlayerStatistics](#DT_PortalPlayerStatistics)|9160 \| 0x23c8|
...
|m_vecCarriedObjectAngles|vector|8684 \| 0x21ec|
|m_vecCarriedObject_CurPosToTargetPos|vector|8704 \| 0x2200|
|m_vecCarriedObject_CurAngToTargetAng|vector|8716 \| 0x220c|
|m_iEntityPortalledNetworkMessageCount|int|9200 \| 0x23f0|
