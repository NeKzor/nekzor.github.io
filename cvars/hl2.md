...
| npc_blob_idle_speed_factor | 0 | sv | - |
| npc_blob_show_centroid | 0 | sv | - |
| npc_blob_sin_amplitude | 60 | sv | - |
| npc_blob_straggler_dist | 240 | sv | - |
| npc_blob_think_interval | 0 | sv | - |
| npc_blob_use_model | 2 | sv | - |
| npc_blob_use_orientation | 1 | sv | - |
| npc_blob_use_threading | 1 | sv | - |
...
| r_particle_timescale | 1 | cheat/cl/dev | - |
...
| sb_firstopentime | 0 | dev | Indicates the time the server browser was first opened. |
| sb_mod_suggested_maxplayers | 0 | - | - |
| sb_numtimesopened | 0 | dev | Indicates the number of times the server browser was opened this session. |
...
| sensitivity | 0 | a/cl | Mouse sensitivity. |
...
| skill | 2 | a | Game skill level (1-3). |
...
| sv_accelerate | 10 | sv/nf/rep/dev | - |
| sv_airaccelerate | 10 | sv/nf/rep/dev | - |
...
| sv_backspeed | 0 | a/sv/rep/dev | How much to slow down backwards motion |
...
| sv_bounce | 0 | sv/nf/rep/dev | Bounce multiplier for when physically simulated objects collide with other objects. |
...
| sv_footsteps | 1 | sv/nf/rep/dev | Play footstep sound for players |
...
| sv_friction | 4 | sv/nf/rep/dev | World friction. |
...
| sv_maxvelocity | 3500 | sv/rep/dev | Maximum speed any ballistically moving object is allowed to attain per axis. |
...
| sv_optimizedmovement | 1 | sv/rep/dev | - |
...
| sv_pushaway_clientside | 0 | sv/rep/dev | Clientside physics push away (0=off, 1=only localplayer, 1=all players) |
| sv_pushaway_clientside_size | 15 | sv/rep/dev | Minimum size of pushback objects |
| sv_pushaway_force | 30000 | sv/rep/dev | How hard physics objects are pushed away from the players on the server. |
| sv_pushaway_max_force | 1000 | sv/rep/dev | Maximum amount of force applied to physics objects by players. |
| sv_pushaway_max_player_force | 10000 | sv/cheat/rep/dev | Maximum of how hard the player is pushed away from physics objects. |
| sv_pushaway_min_player_speed | 75 | sv/rep/dev | If a player is moving slower than this, don't push away physics objects (enables ducking behind things). |
| sv_pushaway_player_force | 200000 | sv/cheat/rep/dev | How hard the player is pushed away from physics objects (falls off with inverse square of distance). |
...
| sv_rollangle | 0 | sv/nf/rep/dev | Max view roll angle |
| sv_rollspeed | 200 | sv/nf/rep/dev | - |
...
| sv_soundemitter_filecheck | cmd | dev | Report missing wave files for sounds and game_sounds files. |
| sv_soundemitter_flush | cmd | dev | Flushes the sounds.txt system (server only) |
...
| sv_suppress_viewpunch | 0 | sv/cheat/rep/dev | - |
...
| sv_unlockedchapters | 15 | a | Highest unlocked game chapter. |
...
| sv_wateraccelerate | 10 | sv/nf/rep/dev | - |
| sv_waterdist | 12 | sv/rep/dev | Vertical view fixup when eyes are near water plane. |
| sv_waterfriction | 1 | sv/nf/rep/dev | - |
...
| tf_arena_max_streak | 3 | nf/rep/cl | Teams will be scrambled if one team reaches this streak |
| tf_arena_preround_time | 10 | nf/rep/cl | Length of the Pre-Round time |
| tf_arena_round_time | 0 | nf/rep/cl | - |
| tf_arena_use_queue | 1 | nf/rep/cl | Enables the spectator queue system for Arena. |
