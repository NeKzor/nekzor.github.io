...
| npc_citizen_heal_chuck_medkit | 1 | a/sv | Set to 1 to use new experimental healthkit-throwing medic. |
| npc_citizen_insignia | 0 | sv | - |
| npc_citizen_medic_emit_sound | 1 | sv | - |
| npc_citizen_medic_throw_speed | 650 | sv | - |
| npc_citizen_medic_throw_style | 1 | a/sv | Set to 0 for a lobbier trajectory |
...
| passenger_collision_response_threshold | 250 | sv | - |
| passenger_debug_entry | 0 | sv | - |
| passenger_debug_transition | 0 | sv | - |
| passenger_impact_response_threshold | -350 | sv | - |
| passenger_use_leaning | 1 | sv | - |
...
| r_portal_use_stencils | 1 | cl | Render portal views using stencils (if available) |
| r_portalscloseall | 0 | - | - |
...
| sk_antlion_worker_burst_damage | 50 | sv | How much damage is inflicted by an antlion worker's death explosion. |
| sk_antlion_worker_burst_radius | 160 | sv | Effect radius of an antlion worker's death explosion. |
| sk_antlion_worker_health | 0 | sv | Hitpoints of an antlion worker. If 0, will use base antlion hitpoints. |
...
| sk_antlion_worker_spit_speed | 0 | sv | Speed at which an antlion spit grenade travels. |
...
| sk_striderbuster_magnet_multiplier | 2 | sv | - |
| sk_suitcharger | 0 | sv | - |
...
| startadmiregloves | cmd | - | Starts the admire gloves animation. |
...
| striderbuster_allow_all_damage | 0 | sv | If set to '1' the bomb will detonate on any damage taken.  Otherwise only the player may trigger it. |
| striderbuster_autoaim_radius | 64 | sv | - |
| striderbuster_debugseek | 0 | sv | - |
| striderbuster_die_detach | 1 | sv | - |
| striderbuster_dive_force | -200 | sv | - |
| striderbuster_falloff_power | 4 | sv | Order of the distance falloff. 1 = linear 2 = quadratic |
| striderbuster_health | 14 | sv | - |
| striderbuster_leg_stick_dist | 80 | sv | If the buster hits a strider's leg, the max distance from the head at which it sticks anyway. |
| striderbuster_magnetic_force_hunter | 1750000 | sv | Intensity of magnade's attraction to a hunter. |
| striderbuster_magnetic_force_strider | 750000 | sv | Intensity of magnade's attraction to a strider. |
| striderbuster_shot_velocity | 2500 | sv | Speed at which launch the bomb from the physcannon |
| striderbuster_use_particle_flare | 1 | sv | - |
| studio_queue_mode | 1 | - | - |
...
| sv_player_funnel_into_portals | 1 | a/sv/rep | Causes the player to auto correct toward the center of floor portals. |
| sv_player_trace_through_portals | 1 | sv/cheat/rep | Causes player movement traces to trace through portals. |
| sv_playerperfhistorycount | 20 | sv | Number of samples to maintain in player perf history |
| sv_portal_collision_sim_bounds_x | 200 | sv/rep | Size of box used to grab collision geometry around placed portals. These should be at the default size or larger only! |
| sv_portal_collision_sim_bounds_y | 200 | sv/rep | Size of box used to grab collision geometry around placed portals. These should be at the default size or larger only! |
| sv_portal_collision_sim_bounds_z | 252 | sv/rep | Size of box used to grab collision geometry around placed portals. These should be at the default size or larger only! |
| sv_portal_debug_touch | 0 | sv/rep | - |
| sv_portal_new_velocity_check | 1 | sv/cheat | - |
| sv_portal_pathtrack_track_width_on | 4 | sv/cheat | - |
| sv_portal_placement_debug | 0 | sv/rep | - |
| sv_portal_placement_never_bump | 0 | sv/cheat/rep | - |
| sv_portal_placement_never_fail | 0 | sv/cheat/rep | - |
| sv_portal_trace_vs_displacements | 1 | sv/cheat/rep | Use traces against portal environment displacement geometry |
| sv_portal_trace_vs_holywall | 1 | sv/cheat/rep | Use traces against portal environment carved wall |
| sv_portal_trace_vs_staticprops | 1 | sv/cheat/rep | Use traces against portal environment static prop geometry |
| sv_portal_trace_vs_world | 1 | sv/cheat/rep | Use traces against portal environment world geometry |
...
| sv_use_find_closest_passable_space | 1 | sv/cheat/rep | Enables heavy-handed player teleporting stuck fix code. |
| sv_use_shadow_clones | 1 | sv/cheat/rep | - |
| sv_use_transformed_collideables | 1 | sv/cheat/rep | Disables traces against remote portal moving entities using transforms to bring them into local space. |
...
| trace_report | 0 | sv | - |
| tracer_extra | 1 | cl | - |
| turret_ground_damage_multiplier | 8 | sv/cheat | - |
...
| upgrade_portalgun | cmd | - | Equips the player with a single portal portalgun. Use twice for a dual portal portalgun.   Arguments:    none |
