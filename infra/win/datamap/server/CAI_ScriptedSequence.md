...
|---|:-:|:-:|--:|
|CAI_ScriptedSequenceScriptThink|void|0 \| 0x0||
...
|InputBeginSequence|void|0 \| 0x0|BeginSequence|
|InputCallScriptFunction|string|0 \| 0x0|CallScriptFunction|
|InputCancelSequence|void|0 \| 0x0|CancelSequence|
...
|InputMoveToPosition|void|0 \| 0x0|MoveToPosition|
...
|m_iszEntry|string|864 \| 0x360|m_iszEntry|
|m_iszPreIdle|string|868 \| 0x364|m_iszIdle|
|m_iszPlay|string|872 \| 0x368|m_iszPlay|
|m_iszPostIdle|string|876 \| 0x36c|m_iszPostIdle|
|m_iszCustomMove|string|880 \| 0x370|m_iszCustomMove|
|m_iszNextScript|string|884 \| 0x374|m_iszNextScript|
|m_iszEntity|string|888 \| 0x378|m_iszEntity|
|m_fMoveTo|integer|892 \| 0x37c|m_fMoveTo|
|m_bIsPlayingEntry|boolean|896 \| 0x380||
|m_bLoopActionSequence|boolean|897 \| 0x381|m_bLoopActionSequence|
|m_bSynchPostIdles|boolean|898 \| 0x382|m_bSynchPostIdles|
|m_bIgnoreGravity|boolean|899 \| 0x383|m_bIgnoreGravity|
|m_bDisableNPCCollisions|boolean|900 \| 0x384|m_bDisableNPCCollisions|
|m_flRadius|float|904 \| 0x388|m_flRadius|
|m_flRepeat|float|908 \| 0x38c|m_flRepeat|
|m_iDelay|integer|912 \| 0x390||
|m_bDelayed|boolean|916 \| 0x394||
|m_startTime|time|920 \| 0x398||
|m_bWaitForBeginSequence|boolean|924 \| 0x39c||
|m_saved_effects|integer|928 \| 0x3a0||
|m_savedFlags|integer|932 \| 0x3a4||
|m_savedCollisionGroup|integer|936 \| 0x3a8||
|m_interruptable|boolean|940 \| 0x3ac||
|m_sequenceStarted|boolean|941 \| 0x3ad||
|m_hTargetEnt|ehandle|944 \| 0x3b0||
|m_hNextCine|ehandle|948 \| 0x3b4||
|m_bThinking|boolean|952 \| 0x3b8||
|m_bInitiatedSelfDelete|boolean|953 \| 0x3b9||
|m_bIsTeleportingDueToMoveTo|boolean|954 \| 0x3ba||
|m_hLastFoundEntity|ehandle|956 \| 0x3bc||
|m_hForcedTarget|ehandle|960 \| 0x3c0||
|m_bDontCancelOtherSequences|boolean|964 \| 0x3c4||
|m_bForceSynch|boolean|965 \| 0x3c5||
|m_bTargetWasAsleep|boolean|966 \| 0x3c6||
|m_OnBeginSequence|custom|968 \| 0x3c8|OnBeginSequence|
|m_OnEndSequence|custom|992 \| 0x3e0|OnEndSequence|
|m_OnPostIdleEndSequence|custom|1016 \| 0x3f8|OnPostIdleEndSequence|
|m_OnCancelSequence|custom|1040 \| 0x410|OnCancelSequence|
|m_OnCancelFailedSequence|custom|1064 \| 0x428|OnCancelFailedSequence|
|m_OnScriptEvent[0]|custom|1088 \| 0x440|OnScriptEvent01|
|m_OnScriptEvent[1]|custom|1112 \| 0x458|OnScriptEvent02|
|m_OnScriptEvent[2]|custom|1136 \| 0x470|OnScriptEvent03|
|m_OnScriptEvent[3]|custom|1160 \| 0x488|OnScriptEvent04|
|m_OnScriptEvent[4]|custom|1184 \| 0x4a0|OnScriptEvent05|
|m_OnScriptEvent[5]|custom|1208 \| 0x4b8|OnScriptEvent06|
|m_OnScriptEvent[6]|custom|1232 \| 0x4d0|OnScriptEvent07|
|m_OnScriptEvent[7]|custom|1256 \| 0x4e8|OnScriptEvent08|
|m_matInteractionPosition|vmatrix|1280 \| 0x500||
|m_hInteractionRelativeEntity|ehandle|1344 \| 0x540||
|m_iPlayerDeathBehavior|integer|1348 \| 0x544|onplayerdeath|
