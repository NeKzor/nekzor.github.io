...
|CFuncRotatingHurtTouch|void|0 \| 0x0||
|CFuncRotatingReverseMove|void|0 \| 0x0||
|CFuncRotatingRotateMove|void|0 \| 0x0||
|CFuncRotatingRotatingUse|void|0 \| 0x0||
|CFuncRotatingSpinDownMove|void|0 \| 0x0||
|CFuncRotatingSpinUpMove|void|0 \| 0x0||
...
|InputGetSpeed|void|0 \| 0x0|GetSpeed|
...
|InputStopAtStartPos|void|0 \| 0x0|StopAtStartPos|
...
|m_vecMoveAng|vector|864 \| 0x360||
|m_flFanFriction|float|876 \| 0x36c||
|m_flAttenuation|float|880 \| 0x370||
|m_flVolume|float|884 \| 0x374||
|m_flTargetSpeed|float|888 \| 0x378||
|m_flMaxSpeed|float|892 \| 0x37c|maxspeed|
|m_flBlockDamage|float|896 \| 0x380|dmg|
|m_NoiseRunning|soundname|900 \| 0x384|message|
|m_bReversed|boolean|904 \| 0x388||
|m_angStart|vector|908 \| 0x38c||
|m_bStopAtStartPos|boolean|920 \| 0x398||
|m_bSolidBsp|boolean|921 \| 0x399|solidbsp|
|m_OnGetSpeed|custom|924 \| 0x39c|OnGetSpeed|
