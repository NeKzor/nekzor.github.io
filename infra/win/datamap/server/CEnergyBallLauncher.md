...
|m_flBallRadius|float|868 \| 0x364|ballradius|
|m_flBallRespawnTime|float|872 \| 0x368|ballrespawntime|
|m_flMinSpeed|float|876 \| 0x36c|minspeed|
|m_flMaxSpeed|float|880 \| 0x370|maxspeed|
|m_BallRespawnTime|custom|884 \| 0x374||
|m_nBallCount|integer|904 \| 0x388|ballcount|
|m_nBallsRemainingInField|integer|908 \| 0x38c||
|m_flRadius|float|912 \| 0x390||
|m_flDisableTime|time|916 \| 0x394||
|m_bEnabled|boolean|920 \| 0x398||
|m_OnBallGrabbed|custom|924 \| 0x39c|OnBallGrabbed|
|m_OnBallReinserted|custom|948 \| 0x3b4|OnBallReinserted|
|m_OnBallHitTopSide|custom|972 \| 0x3cc|OnBallHitTopSide|
|m_OnBallHitBottomSide|custom|996 \| 0x3e4|OnBallHitBottomSide|
|m_OnLastBallGrabbed|custom|1020 \| 0x3fc|OnLastBallGrabbed|
|m_OnFirstBallReinserted|custom|1044 \| 0x414|OnFirstBallReinserted|
|m_iBounces|integer|1068 \| 0x42c|maxballbounces|
|m_flConeDegrees|float|1072 \| 0x430|launchconenoise|
|m_iszBullseyeName|string|1076 \| 0x434|bullseyename|
|m_fBallLifetime|float|1080 \| 0x438|BallLifetime|
|m_fMinBallLifeAfterPortal|float|1084 \| 0x43c|MinLifeAfterPortal|
|m_OnPostSpawnBall|custom|1088 \| 0x440|OnPostSpawnBall|
|m_OnBallCaught|custom|1112 \| 0x458|OnBallCaught|
