...
|CGibShooterShootThink|void|0 \| 0x0||
...
|m_iGibs|integer|864 \| 0x360|m_iGibs|
|m_iGibCapacity|integer|868 \| 0x364||
|m_iGibMaterial|integer|872 \| 0x368||
|m_iGibModelIndex|integer|876 \| 0x36c||
|m_flGibVelocity|float|880 \| 0x370|m_flVelocity|
|m_angGibRotation|vector|884 \| 0x374|gibangles|
|m_flGibAngVelocity|float|896 \| 0x380|gibanglevelocity|
|m_flVariance|float|900 \| 0x384|m_flVariance|
|m_flGibLife|float|904 \| 0x388|m_flGibLife|
|m_nSimulationType|integer|908 \| 0x38c|Simulation|
|m_nMaxGibModelFrame|integer|912 \| 0x390||
|m_flDelay|float|916 \| 0x394|delay|
|m_bNoGibShadows|boolean|920 \| 0x398|nogibshadows|
|m_bIsSprite|boolean|921 \| 0x399||
|m_iszLightingOrigin|string|924 \| 0x39c|LightingOrigin|
