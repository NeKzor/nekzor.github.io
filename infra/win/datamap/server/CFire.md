...
|m_hEffect|ehandle|864 \| 0x360||
|m_hOwner|ehandle|868 \| 0x364||
|m_nFireType|integer|872 \| 0x368|firetype|
|m_flFuel|float|876 \| 0x36c||
|m_flDamageTime|time|880 \| 0x370||
|m_lastDamage|time|884 \| 0x374||
|m_flFireSize|float|888 \| 0x378|firesize|
|m_flHeatLevel|float|896 \| 0x380|ignitionpoint|
|m_flHeatAbsorb|float|900 \| 0x384||
|m_flDamageScale|float|904 \| 0x388|damagescale|
|m_flMaxHeat|float|908 \| 0x38c||
|m_flAttackTime|float|916 \| 0x394|fireattack|
|m_bEnabled|boolean|920 \| 0x398||
|m_bStartDisabled|boolean|921 \| 0x399|StartDisabled|
|m_bDidActivate|boolean|922 \| 0x39a||
|m_OnIgnited|custom|924 \| 0x39c|OnIgnited|
|m_OnExtinguished|custom|948 \| 0x3b4|OnExtinguished|
