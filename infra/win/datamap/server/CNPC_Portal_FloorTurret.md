...
|CNPC_Portal_FloorTurretRetire|void|0 \| 0x0||
...
|InputFireBullet|string|0 \| 0x0|FireBullet|
...
|InputSetModel|integer|0 \| 0x0|SetModel|
...
|m_OnAlyxStartedInteraction|custom|3656 \| 0xe48|OnAlyxStartedInteraction|
|m_OnAlyxFinishedInteraction|custom|3680 \| 0xe60|OnAlyxFinishedInteraction|
|m_iAmmoType|integer|3760 \| 0xeb0||
|m_bAutoStart|boolean|3764 \| 0xeb4||
|m_bActive|boolean|3765 \| 0xeb5||
|m_bBlinkState|boolean|3766 \| 0xeb6||
|m_bEnabled|boolean|3767 \| 0xeb7||
|m_bNoAlarmSounds|boolean|3768 \| 0xeb8||
|m_bSelfDestructing|boolean|3769 \| 0xeb9||
|m_flDestructStartTime|time|3772 \| 0xebc||
|m_flShotTime|time|3776 \| 0xec0||
|m_flLastSight|time|3780 \| 0xec4||
|m_flThrashTime|time|3784 \| 0xec8||
|m_flPingTime|time|3788 \| 0xecc||
|m_flNextActivateSoundTime|time|3792 \| 0xed0||
|m_bCarriedByPlayer|boolean|3796 \| 0xed4||
|m_bUseCarryAngles|boolean|3797 \| 0xed5||
|m_flPlayerDropTime|time|3800 \| 0xed8||
|m_iKeySkin|integer|3804 \| 0xedc|SkinNumber|
|m_hLastNPCToKickMe|ehandle|3808 \| 0xee0||
|m_flKnockOverFailedTime|time|3812 \| 0xee4||
|m_vecGoalAngles|vector|3816 \| 0xee8||
|m_iEyeAttachment|integer|3828 \| 0xef4||
|m_iMuzzleAttachment|integer|3832 \| 0xef8||
|m_iEyeState|integer|3836 \| 0xefc||
|m_hEyeGlow|ehandle|3840 \| 0xf00||
|m_hLaser|ehandle|3844 \| 0xf04||
|m_pMotionController|ehandle|3848 \| 0xf08||
|m_vecEnemyLKP|vector|3852 \| 0xf0c||
|m_hPhysicsAttacker|ehandle|3864 \| 0xf18||
|m_flLastPhysicsInfluenceTime|time|3868 \| 0xf1c||
|m_OnDeploy|custom|3872 \| 0xf20|OnDeploy|
|m_OnRetire|custom|3896 \| 0xf38|OnRetire|
|m_OnTipped|custom|3920 \| 0xf50|OnTipped|
|m_OnExplode|custom|3944 \| 0xf68|OnExplode|
|m_OnPhysGunPickup|custom|3968 \| 0xf80|OnPhysGunPickup|
|m_OnPhysGunDrop|custom|3992 \| 0xf98|OnPhysGunDrop|
|m_bHackedByAlyx|boolean|4016 \| 0xfb0||
|m_iPaintPower|integer|4032 \| 0xfc0||
|m_nOriginalMaterialIndex|custom|4300 \| 0x10cc||
|m_PrePaintedPower|integer|4304 \| 0x10d0|PaintPower|
|m_bOutOfAmmo|boolean|4340 \| 0x10f4||
|m_bLaserOn|boolean|4341 \| 0x10f5||
|m_bIsFiring|boolean|4342 \| 0x10f6||
|m_sLaserHaloSprite|integer|4344 \| 0x10f8||
|m_bIsDead|boolean|4348 \| 0x10fc||
|m_iNextShootingBarrel|integer|4368 \| 0x1110||
|m_bDamageForce|boolean|4372 \| 0x1114|DamageForce|
|m_bPickupEnabled|boolean|4373 \| 0x1115|PickupEnabled|
|m_bDisableMotion|boolean|4374 \| 0x1116|DisableMotion|
|m_bAllowShootThroughPortals|boolean|4375 \| 0x1117|AllowShootThroughPortals|
|m_nCollisionType|integer|4376 \| 0x1118|CollisionType|
|m_flTurretRange|float|4380 \| 0x111c|TurretRange|
|m_bLoadAlternativeModels|boolean|4384 \| 0x1120|LoadAlternativeModels|
|m_fSearchSpeed|float|4388 \| 0x1124||
|m_flDistToEnemy|float|4392 \| 0x1128||
|m_iLastState|integer|4404 \| 0x1134||
|m_fNextTalk|float|4408 \| 0x1138||
|m_bDelayTippedTalk|boolean|4412 \| 0x113c||
|m_bUsedAsActor|boolean|4413 \| 0x113d|UsedAsActor|
|m_bGagged|boolean|4414 \| 0x113e|Gagged|
|m_bSeeEnemyThroughPortal|boolean|4415 \| 0x113f||
|m_nModelIndex|integer|4416 \| 0x1140|ModelIndex|
|m_bUseSuperDamageScale|boolean|4424 \| 0x1148|UseSuperDamageScale|
|m_OnPainted|custom|4428 \| 0x114c|OnPainted|
|m_hPreviousHeldOwner|ehandle|4452 \| 0x1164||
