...
|InputAddToTimer|float|0 \| 0x0|AddToTimer|
...
|InputFireTimer|void|0 \| 0x0|FireTimer|
...
|InputSubtractFromTimer|float|0 \| 0x0|SubtractFromTimer|
...
|m_OnTimer|custom|864 \| 0x360|OnTimer|
|m_OnTimerHigh|custom|888 \| 0x378|OnTimerHigh|
|m_OnTimerLow|custom|912 \| 0x390|OnTimerLow|
|m_iDisabled|integer|936 \| 0x3a8|StartDisabled|
|m_flRefireTime|float|940 \| 0x3ac|RefireTime|
|m_bUpDownState|boolean|944 \| 0x3b0||
|m_iUseRandomTime|integer|948 \| 0x3b4|UseRandomTime|
|m_flLowerRandomBound|float|952 \| 0x3b8|LowerRandomBound|
|m_flUpperRandomBound|float|956 \| 0x3bc|UpperRandomBound|
