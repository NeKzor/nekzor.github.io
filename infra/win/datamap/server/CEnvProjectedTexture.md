...
|CEnvProjectedTextureInitialThink|void|0 \| 0x0||
...
|InputAlwaysUpdateOff|void|0 \| 0x0|AlwaysUpdateOff|
|InputAlwaysUpdateOn|void|0 \| 0x0|AlwaysUpdateOn|
...
|InputSetAmbient|float|0 \| 0x0|Ambient|
|InputSetCameraSpace|boolean|0 \| 0x0|CameraSpace|
|InputSetDamageFilter|string|0 \| 0x0|SetDamageFilter|
|InputSetEnableShadows|boolean|0 \| 0x0|EnableShadows|
|InputSetFarZ|float|0 \| 0x0|SetFarZ|
|InputSetFOV|float|0 \| 0x0|FOV|
|InputSetLightColor|color32|0 \| 0x0|LightColor|
|InputSetLightOnlyTarget|boolean|0 \| 0x0|LightOnlyTarget|
|InputSetLightStyle|integer|0 \| 0x0|SetLightStyle|
|InputSetLightWorld|boolean|0 \| 0x0|LightWorld|
|InputSetLocalAngles|string|0 \| 0x0|SetLocalAngles|
|InputSetLocalOrigin|string|0 \| 0x0|SetLocalOrigin|
|InputSetNearZ|float|0 \| 0x0|SetNearZ|
...
|InputSetPattern|string|0 \| 0x0|SetPattern|
|InputSetSpotlightTexture|string|0 \| 0x0|SpotlightTexture|
|InputSetTarget|ehandle|0 \| 0x0|Target|
...
|m_bState|boolean|868 \| 0x364||
|m_bAlwaysUpdate|boolean|869 \| 0x365||
|m_flLightFOV|float|872 \| 0x368|lightfov|
|m_bEnableShadows|boolean|876 \| 0x36c|enableshadows|
|m_bSimpleProjection|boolean|877 \| 0x36d|simpleprojection|
|m_bSimpleProjection|boolean|877 \| 0x36d||
|m_bLightOnlyTarget|boolean|878 \| 0x36e|lightonlytarget|
|m_bLightWorld|boolean|879 \| 0x36f|lightworld|
|m_bLightViewModels|boolean|880 \| 0x370|lightviewmodels|
|m_bLightNotPVSCulled|boolean|881 \| 0x371|lightnotpvsculled|
|m_bCameraSpace|boolean|882 \| 0x372|cameraspace|
|m_flBrightnessScale|float|884 \| 0x374|brightnessscale|
|m_LightColor|color32|888 \| 0x378||
|m_flColorTransitionTime|float|892 \| 0x37c|colortransitiontime|
|m_flAmbient|float|896 \| 0x380|ambient|
|m_SpotlightTextureName|character|900 \| 0x384|texturename|
|m_nSpotlightTextureFrame|integer|1160 \| 0x488|textureframe|
|m_flNearZ|float|1164 \| 0x48c|nearz|
|m_flFarZ|float|1168 \| 0x490|farz|
|m_nShadowQuality|integer|1172 \| 0x494|shadowquality|
|m_flProjectionSize|float|1176 \| 0x498|projection_size|
|m_flRotation|float|1180 \| 0x49c|projection_rotation|
|m_iStyle|integer|1184 \| 0x4a0|style|
|m_iDefaultStyle|integer|1188 \| 0x4a4|defaultstyle|
|m_iszPattern|string|1192 \| 0x4a8|pattern|
