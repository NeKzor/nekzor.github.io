...
|InputSetStateAFalse|input|0 \| 0x0|SetStateAFalse|
|InputSetStateATrue|input|0 \| 0x0|SetStateATrue|
|InputSetStateBFalse|input|0 \| 0x0|SetStateBFalse|
|InputSetStateBTrue|input|0 \| 0x0|SetStateBTrue|
|InputSetTeam|integer|0 \| 0x0|SetTeam|
|InputToggleStateA|input|0 \| 0x0|ToggleStateA|
|InputToggleStateB|input|0 \| 0x0|ToggleStateB|
...
|m_OnChangeToAllTrue|custom|864 \| 0x360|OnChangeToAllTrue|
|m_OnChangeToAnyTrue|custom|888 \| 0x378|OnChangeToAnyTrue|
|m_OnChangeToAllFalse|custom|912 \| 0x390|OnChangeToAllFalse|
|m_OnChangeToAnyFalse|custom|936 \| 0x3a8|OnChangeToAnyFalse|
|m_bPlayerStateA|boolean|964 \| 0x3c4|DefaultPlayerStateA|
|m_bPlayerStateB|boolean|965 \| 0x3c5|DefaultPlayerStateB|
