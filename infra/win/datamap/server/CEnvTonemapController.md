...
|CEnvTonemapControllerUpdateTonemapScaleBlend|void|0 \| 0x0||
...
|InputBlendTonemapScale|string|0 \| 0x0|BlendTonemapScale|
...
|InputSetAutoExposureMax|float|0 \| 0x0|SetAutoExposureMax|
|InputSetAutoExposureMin|float|0 \| 0x0|SetAutoExposureMin|
|InputSetBloomExponent|float|0 \| 0x0|SetBloomExponent|
|InputSetBloomSaturation|float|0 \| 0x0|SetBloomSaturation|
|InputSetBloomScale|float|0 \| 0x0|SetBloomScale|
|InputSetBloomScaleRange|float|0 \| 0x0|SetBloomScaleRange|
...
|InputSetTonemapRate|float|0 \| 0x0|SetTonemapRate|
|InputSetTonemapScale|float|0 \| 0x0|SetTonemapScale|
|InputUse|void|0 \| 0x0|Use|
|InputUseDefaultAutoExposure|void|0 \| 0x0|UseDefaultAutoExposure|
|InputUseDefaultBloomScale|void|0 \| 0x0|UseDefaultBloomScale|
...
|m_flBlendTonemapStart|float|864 \| 0x360||
|m_flBlendTonemapEnd|float|868 \| 0x364||
|m_flBlendEndTime|time|872 \| 0x368||
|m_flBlendStartTime|time|876 \| 0x36c||
|m_bUseCustomAutoExposureMin|boolean|880 \| 0x370||
|m_bUseCustomAutoExposureMax|boolean|881 \| 0x371||
|m_bUseCustomBloomScale|boolean|882 \| 0x372||
