...
|InputSetMeasureTarget|string|0 \| 0x0|SetMeasureTarget|
...
|InputSetSpeakerName|string|0 \| 0x0|SetSpeakerName|
...
|m_hMeasureTarget|ehandle|868 \| 0x364||
|m_nSoundMask|integer|872 \| 0x368|SoundMask|
|m_flSensitivity|float|876 \| 0x36c|Sensitivity|
|m_flSmoothFactor|float|880 \| 0x370|SmoothFactor|
|m_flMaxRange|float|884 \| 0x374|MaxRange|
|m_iszSpeakerName|string|888 \| 0x378|SpeakerName|
|m_hSpeaker|ehandle|892 \| 0x37c||
|m_iSpeakerDSPPreset|integer|900 \| 0x384|speaker_dsp_preset|
|m_iszListenFilter|string|904 \| 0x388|ListenFilter|
|m_hListenFilter|ehandle|908 \| 0x38c||
|m_SoundLevel|custom|912 \| 0x390|SoundLevel|
|m_OnRoutedSound|custom|936 \| 0x3a8|OnRoutedSound|
|m_OnHeardSound|custom|960 \| 0x3c0|OnHeardSound|
|m_szLastSound|character|984 \| 0x3d8||
