...
|InputAmplitude|float|0 \| 0x0|Amplitude|
...
|InputFrequency|float|0 \| 0x0|Frequency|
...
|InputStartShake|void|0 \| 0x0|StartShake|
|InputStopShake|void|0 \| 0x0|StopShake|
...
|m_Amplitude|float|864 \| 0x360|amplitude|
|m_Frequency|float|868 \| 0x364|frequency|
|m_Duration|float|872 \| 0x368|duration|
|m_Radius|float|876 \| 0x36c|radius|
|m_stopTime|time|880 \| 0x370||
|m_nextShake|time|884 \| 0x374||
|m_currentAmp|float|888 \| 0x378||
|m_maxForce|vector|892 \| 0x37c||
|m_pShakeController|custom|904 \| 0x388||
|m_shakeCallback|[CPhysicsShake](#cphysicsshake)|908 \| 0x38c||
