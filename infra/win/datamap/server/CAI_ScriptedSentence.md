...
|m_iszSentence|string|864 \| 0x360|sentence|
|m_iszEntity|string|868 \| 0x364|entity|
|m_flRadius|float|872 \| 0x368|radius|
|m_flDelay|float|876 \| 0x36c|delay|
|m_flRepeat|float|880 \| 0x370|refire|
|m_iSoundLevel|integer|884 \| 0x374||
|m_TempAttenuation|integer|888 \| 0x378|attenuation|
|m_flVolume|float|892 \| 0x37c||
|m_active|boolean|896 \| 0x380||
|m_iszListener|string|900 \| 0x384|listener|
|m_pActivator|ehandle|904 \| 0x388||
|m_OnBeginSentence|custom|908 \| 0x38c|OnBeginSentence|
|m_OnEndSentence|custom|932 \| 0x3a4|OnEndSentence|
