...
|CEnvGunfireShootThink|void|0 \| 0x0||
...
|m_iMinBurstSize|integer|864 \| 0x360|minburstsize|
|m_iMaxBurstSize|integer|868 \| 0x364|maxburstsize|
|m_flMinBurstDelay|time|872 \| 0x368|minburstdelay|
|m_flMaxBurstDelay|time|876 \| 0x36c|maxburstdelay|
|m_flRateOfFire|float|880 \| 0x370|rateoffire|
|m_iszShootSound|string|884 \| 0x374|shootsound|
|m_iszTracerType|string|888 \| 0x378|tracertype|
|m_bDisabled|boolean|892 \| 0x37c|startdisabled|
|m_iShotsRemaining|integer|896 \| 0x380||
|m_iSpread|integer|900 \| 0x384|spread|
|m_vecSpread|vector|904 \| 0x388||
|m_vecTargetPosition|vector|916 \| 0x394||
|m_flTargetDist|float|928 \| 0x3a0||
|m_flBias|float|932 \| 0x3a4|bias|
|m_bCollide|boolean|936 \| 0x3a8|collisions|
