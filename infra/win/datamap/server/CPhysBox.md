...
|InputBecomeDebris|void|0 \| 0x0|BecomeDebris|
...
|InputForceDrop|void|0 \| 0x0|ForceDrop|
...
|m_Material|integer|872 \| 0x368||
|m_hBreaker|ehandle|876 \| 0x36c||
|m_Explosion|integer|880 \| 0x370|explosion|
|m_GibDir|vector|884 \| 0x374|gibdir|
|m_iszGibModel|string|896 \| 0x380||
|m_iszSpawnObject|string|900 \| 0x384||
|m_ExplosionMagnitude|integer|904 \| 0x388|explodemagnitude|
|m_flPressureDelay|float|908 \| 0x38c|PressureDelay|
|m_iMinHealthDmg|integer|912 \| 0x390|minhealthdmg|
|m_bTookPhysicsDamage|boolean|916 \| 0x394||
|m_iszPropData|string|920 \| 0x398||
|m_iszModelName|string|924 \| 0x39c||
|m_impactEnergyScale|float|928 \| 0x3a0|physdamagescale|
|m_OnBreak|custom|932 \| 0x3a4|OnBreak|
|m_OnHealthChanged|custom|956 \| 0x3bc|OnHealthChanged|
|m_flDmgModBullet|float|980 \| 0x3d4||
|m_flDmgModClub|float|984 \| 0x3d8||
|m_flDmgModExplosive|float|988 \| 0x3dc||
|m_flDmgModFire|float|992 \| 0x3e0||
|m_iszPhysicsDamageTableName|string|996 \| 0x3e4||
|m_iszBreakableModel|string|1000 \| 0x3e8||
|m_iBreakableSkin|integer|1004 \| 0x3ec||
|m_iBreakableCount|integer|1008 \| 0x3f0||
|m_iMaxBreakableSize|integer|1012 \| 0x3f4||
|m_iszBasePropData|string|1016 \| 0x3f8||
|m_iInteractions|integer|1020 \| 0x3fc||
|m_PerformanceMode|integer|1024 \| 0x400|PerformanceMode|
|m_explodeRadius|float|1028 \| 0x404||
|m_hPhysicsAttacker|ehandle|1032 \| 0x408||
|m_flLastPhysicsInfluenceTime|time|1036 \| 0x40c||
|m_damageType|integer|1040 \| 0x410|Damagetype|
|m_massScale|float|1044 \| 0x414|massScale|
|m_iszOverrideScript|string|1048 \| 0x418|overridescript|
|m_damageToEnableMotion|integer|1052 \| 0x41c|damagetoenablemotion|
|m_flForceToEnableMotion|float|1056 \| 0x420|forcetoenablemotion|
|m_angPreferredCarryAngles|vector|1060 \| 0x424|preferredcarryangles|
|m_bNotSolidToWorld|boolean|1072 \| 0x430|notsolid|
|m_iExploitableByPlayer|integer|1076 \| 0x434|ExploitableByPlayer|
|m_OnDamaged|custom|1080 \| 0x438|OnDamaged|
|m_OnAwakened|custom|1104 \| 0x450|OnAwakened|
|m_OnMotionEnabled|custom|1128 \| 0x468|OnMotionEnabled|
|m_OnPhysGunPickup|custom|1152 \| 0x480|OnPhysGunPickup|
|m_OnPhysGunPunt|custom|1176 \| 0x498|OnPhysGunPunt|
|m_OnPhysGunOnlyPickup|custom|1200 \| 0x4b0|OnPhysGunOnlyPickup|
|m_OnPhysGunDrop|custom|1224 \| 0x4c8|OnPhysGunDrop|
|m_OnPlayerUse|custom|1248 \| 0x4e0|OnPlayerUse|
|m_hCarryingPlayer|ehandle|1272 \| 0x4f8||
