...
|m_hPlayer|ehandle|864 \| 0x360||
|m_hTarget|ehandle|868 \| 0x364||
|m_pPath|classptr|872 \| 0x368||
|m_sPath|string|876 \| 0x36c||
|m_flWait|float|880 \| 0x370||
|m_flReturnTime|time|884 \| 0x374||
|m_flStopTime|time|888 \| 0x378||
|m_moveDistance|float|892 \| 0x37c||
|m_targetSpeed|float|896 \| 0x380||
|m_initialSpeed|float|900 \| 0x384||
|m_acceleration|float|904 \| 0x388||
|m_deceleration|float|908 \| 0x38c||
|m_state|integer|912 \| 0x390||
|m_vecMoveDir|vector|916 \| 0x394||
|m_fov|float|928 \| 0x3a0|fov|
|m_fovSpeed|float|932 \| 0x3a4|fov_rate|
|m_trackSpeed|float|936 \| 0x3a8|trackspeed|
|m_iszTargetAttachment|string|940 \| 0x3ac|targetattachment|
|m_iAttachmentIndex|integer|944 \| 0x3b0||
|m_bSnapToGoal|boolean|948 \| 0x3b4||
|m_nPlayerButtons|integer|952 \| 0x3b8||
|m_nOldTakeDamage|integer|956 \| 0x3bc||
|m_OnEndFollow|custom|960 \| 0x3c0|OnEndFollow|
