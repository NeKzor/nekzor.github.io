...
|m_flPostProcessParameters[ PPPN_FADE_TIME ]|float|864 \| 0x360|fadetime|
|m_flPostProcessParameters[ PPPN_LOCAL_CONTRAST_STRENGTH ]|float|868 \| 0x364|localcontraststrength|
|m_flPostProcessParameters[ PPPN_LOCAL_CONTRAST_EDGE_STRENGTH ]|float|872 \| 0x368|localcontrastedgestrength|
|m_flPostProcessParameters[ PPPN_VIGNETTE_START ]|time|876 \| 0x36c|vignettestart|
|m_flPostProcessParameters[ PPPN_VIGNETTE_END ]|time|880 \| 0x370|vignetteend|
|m_flPostProcessParameters[ PPPN_VIGNETTE_BLUR_STRENGTH ]|float|884 \| 0x374|vignetteblurstrength|
|m_flPostProcessParameters[ PPPN_FADE_TO_BLACK_STRENGTH ]|float|888 \| 0x378|fadetoblackstrength|
|m_flPostProcessParameters[ PPPN_DEPTH_BLUR_FOCAL_DISTANCE ]|float|892 \| 0x37c|depthblurfocaldistance|
|m_flPostProcessParameters[ PPPN_DEPTH_BLUR_STRENGTH ]|float|896 \| 0x380|depthblurstrength|
|m_flPostProcessParameters[ PPPN_SCREEN_BLUR_STRENGTH ]|float|900 \| 0x384|screenblurstrength|
|m_flPostProcessParameters[ PPPN_FILM_GRAIN_STRENGTH ]|float|904 \| 0x388|filmgrainstrength|
