...
|CEnvEntityMakerCheckSpawnThink|void|0 \| 0x0||
...
|InputForceSpawnAtEntityOrigin|string|0 \| 0x0|ForceSpawnAtEntityOrigin|
...
|m_hCurrentInstance|ehandle|888 \| 0x378||
|m_hCurrentBlocker|ehandle|892 \| 0x37c||
|m_vecBlockerOrigin|vector|896 \| 0x380||
|m_angPostSpawnDirection|vector|908 \| 0x38c|PostSpawnDirection|
|m_flPostSpawnDirectionVariance|float|920 \| 0x398|PostSpawnDirectionVariance|
|m_flPostSpawnSpeed|float|924 \| 0x39c|PostSpawnSpeed|
|m_bPostSpawnUseAngles|boolean|928 \| 0x3a0|PostSpawnInheritAngles|
|m_iszTemplate|string|932 \| 0x3a4|EntityTemplate|
|m_pOutputOnSpawned|custom|936 \| 0x3a8|OnEntitySpawned|
|m_pOutputOnFailedSpawn|custom|960 \| 0x3c0|OnEntityFailedSpawn|
