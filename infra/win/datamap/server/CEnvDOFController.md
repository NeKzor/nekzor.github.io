...
|CEnvDOFControllerUpdateParamBlend|void|0 \| 0x0||
...
|InputSetFarBlurDepth|float|0 \| 0x0|SetFarBlurDepth|
|InputSetFarBlurRadius|float|0 \| 0x0|SetFarBlurRadius|
|InputSetFarFocusDepth|float|0 \| 0x0|SetFarFocusDepth|
|InputSetFocusTarget|string|0 \| 0x0|SetFocusTarget|
|InputSetFocusTargetRange|string|0 \| 0x0|SetFocusTargetRange|
|InputSetLocalAngles|string|0 \| 0x0|SetLocalAngles|
|InputSetLocalOrigin|string|0 \| 0x0|SetLocalOrigin|
|InputSetNearBlurDepth|float|0 \| 0x0|SetNearBlurDepth|
|InputSetNearBlurRadius|float|0 \| 0x0|SetNearBlurRadius|
|InputSetNearFocusDepth|float|0 \| 0x0|SetNearFocusDepth|
...
|m_flFocusTargetRange|float|864 \| 0x360|focus_range|
|m_strFocusTargetName|string|868 \| 0x364|focus_target|
|m_hFocusTarget|ehandle|872 \| 0x368||
|m_bDOFEnabled|boolean|876 \| 0x36c|enabled|
|m_flNearBlurDepth|float|880 \| 0x370|near_blur|
|m_flNearFocusDepth|float|884 \| 0x374|near_focus|
|m_flFarFocusDepth|float|888 \| 0x378|far_focus|
|m_flFarBlurDepth|float|892 \| 0x37c|far_blur|
|m_flNearBlurRadius|float|896 \| 0x380|near_radius|
|m_flFarBlurRadius|float|900 \| 0x384|far_radius|
