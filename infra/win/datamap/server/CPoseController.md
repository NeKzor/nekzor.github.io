...
|m_hProps|ehandle|864 \| 0x360||
|m_chPoseIndex|character|880 \| 0x370||
|m_bDisablePropLookup|boolean|884 \| 0x374||
|m_bPoseValueParity|boolean|885 \| 0x375||
|m_iszPropName|string|888 \| 0x378|PropName|
|m_iszPoseParameterName|string|892 \| 0x37c|PoseParameterName|
|m_fPoseValue|float|896 \| 0x380|PoseValue|
|m_fInterpolationTime|float|900 \| 0x384|InterpolationTime|
|m_bInterpolationWrap|boolean|904 \| 0x388|InterpolationWrap|
|m_fCycleFrequency|float|908 \| 0x38c|CycleFrequency|
|m_nFModType|integer|912 \| 0x390|FModType|
|m_fFModTimeOffset|float|916 \| 0x394|FModTimeOffset|
|m_fFModRate|float|920 \| 0x398|FModRate|
|m_fFModAmplitude|float|924 \| 0x39c|FModAmplitude|
