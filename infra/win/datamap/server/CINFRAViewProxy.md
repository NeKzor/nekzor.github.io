...
|CINFRAViewProxyTranslateViewToProxy|void|0 \| 0x0||
...
|InputOffsetToPlayerAndEnable|void|0 \| 0x0|OffsetToPlayerAndEnable|
...
|InputSetProxy|string|0 \| 0x0|SetProxy|
...
|m_vecInitialPosition|pos-vector|888 \| 0x378||
|m_flTiltFraction|float|900 \| 0x384|tiltfraction|
|m_bEaseAnglesToCamera|boolean|904 \| 0x388|easeanglestocamera|
|m_bIgnoreRoll|boolean|905 \| 0x389|ignoreroll|
|m_bIgnoreAngle|boolean|906 \| 0x38a|ignoreangle|
|m_nPlayerButtons|integer|908 \| 0x38c||
|m_nOldTakeDamage|integer|912 \| 0x390||
|shouldTransition|boolean|916 \| 0x394|shouldtransition|
