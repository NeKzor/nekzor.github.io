...
|CFuncTrackTrainDeadEnd|void|0 \| 0x0||
|CFuncTrackTrainFind|void|0 \| 0x0||
|CFuncTrackTrainNearestPath|void|0 \| 0x0||
|CFuncTrackTrainNext|void|0 \| 0x0||
...
|InputLockOrientation|void|0 \| 0x0|LockOrientation|
|InputMoveToPathNode|string|0 \| 0x0|MoveToPathNode|
|InputRemoveContext|string|0 \| 0x0|RemoveContext|
|InputRemovePaint|void|0 \| 0x0|RemovePaint|
|InputResume|void|0 \| 0x0|Resume|
|InputReverse|void|0 \| 0x0|Reverse|
...
|InputSetMaxSpeed|float|0 \| 0x0|SetMaxSpeed|
...
|InputSetSpeedDir|float|0 \| 0x0|SetSpeedDir|
|InputSetSpeedDirAccel|float|0 \| 0x0|SetSpeedDirAccel|
|InputSetSpeedReal|float|0 \| 0x0|SetSpeedReal|
|InputSetTeam|integer|0 \| 0x0|SetTeam|
|InputStartBackward|void|0 \| 0x0|StartBackward|
|InputStartForward|void|0 \| 0x0|StartForward|
|InputStop|void|0 \| 0x0|Stop|
|InputTeleportToPathNode|string|0 \| 0x0|TeleportToPathNode|
|InputToggle|void|0 \| 0x0|Toggle|
|InputUnlockOrientation|void|0 \| 0x0|UnlockOrientation|
...
|m_ppath|classptr|864 \| 0x360||
|m_length|float|868 \| 0x364|wheels|
|m_controlMins|vector|872 \| 0x368||
|m_controlMaxs|vector|884 \| 0x374||
|m_flVolume|float|912 \| 0x390||
|m_flBank|float|916 \| 0x394|bank|
|m_oldSpeed|float|920 \| 0x398||
|m_flBlockDamage|float|924 \| 0x39c|dmg|
|m_height|float|928 \| 0x3a0|height|
|m_maxSpeed|float|932 \| 0x3a4|startspeed|
|m_dir|float|936 \| 0x3a8||
|m_iszSoundMove|soundname|940 \| 0x3ac|MoveSound|
|m_iszSoundMovePing|soundname|944 \| 0x3b0|MovePingSound|
|m_iszSoundStart|soundname|948 \| 0x3b4|StartSound|
|m_iszSoundStop|soundname|952 \| 0x3b8|StopSound|
|m_strPathTarget|string|956 \| 0x3bc||
|m_flMoveSoundMinTime|float|960 \| 0x3c0|MoveSoundMinTime|
|m_flMoveSoundMaxTime|float|964 \| 0x3c4|MoveSoundMaxTime|
|m_flNextMoveSoundTime|time|968 \| 0x3c8||
|m_nMoveSoundMinPitch|integer|972 \| 0x3cc|MoveSoundMinPitch|
|m_nMoveSoundMaxPitch|integer|976 \| 0x3d0|MoveSoundMaxPitch|
|m_eOrientationType|integer|980 \| 0x3d4|orientationtype|
|m_eVelocityType|integer|984 \| 0x3d8|velocitytype|
|m_bSoundPlaying|boolean|988 \| 0x3dc||
|m_OnStart|custom|992 \| 0x3e0|OnStart|
|m_OnNext|custom|1016 \| 0x3f8|OnNextPoint|
|m_OnArrivedAtDestinationNode|custom|1040 \| 0x410|OnArrivedAtDestinationNode|
|m_bManualSpeedChanges|boolean|1064 \| 0x428|ManualSpeedChanges|
|m_flAccelSpeed|float|1076 \| 0x434|ManualAccelSpeed|
|m_flDecelSpeed|float|1080 \| 0x438|ManualDecelSpeed|
|m_OnDeath|custom|1092 \| 0x444|OnDeath|
