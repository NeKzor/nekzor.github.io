...
|m_TargetFOV|float|864 \| 0x360||
|m_DegreesPerSecond|float|868 \| 0x364||
|m_FOV|float|872 \| 0x368|FOV|
|m_Resolution|float|876 \| 0x36c|resolution|
|m_bFogEnable|boolean|880 \| 0x370|fogEnable|
|m_FogColor|color32|881 \| 0x371|fogColor|
|m_flFogStart|float|888 \| 0x378|fogStart|
|m_flFogEnd|float|892 \| 0x37c|fogEnd|
|m_flFogMaxDensity|float|896 \| 0x380|fogMaxDensity|
|m_bActive|boolean|900 \| 0x384||
|m_bUseScreenAspectRatio|boolean|901 \| 0x385|UseScreenAspectRatio|
|m_bIsOn|boolean|902 \| 0x386||
