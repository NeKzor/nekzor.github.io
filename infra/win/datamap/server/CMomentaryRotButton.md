...
|---|:-:|:-:|--:|
|CBaseButtonButtonBackHome|void|0 \| 0x0||
|CBaseButtonButtonReturn|void|0 \| 0x0||
|CBaseButtonButtonSpark|void|0 \| 0x0||
|CBaseButtonButtonTouch|void|0 \| 0x0||
|CBaseButtonButtonUse|void|0 \| 0x0||
|CBaseButtonTriggerAndWait|void|0 \| 0x0||
...
|CMomentaryRotButtonReturnMoveDone|void|0 \| 0x0||
|CMomentaryRotButtonSetPositionMoveDone|void|0 \| 0x0||
|CMomentaryRotButtonUpdateThink|void|0 \| 0x0||
|CMomentaryRotButtonUseMoveDone|void|0 \| 0x0||
...
|InputDisableUpdateTarget|void|0 \| 0x0|_DisableUpdateTarget|
...
|InputEnableUpdateTarget|void|0 \| 0x0|_EnableUpdateTarget|
...
|InputPress|void|0 \| 0x0|Press|
|InputPressIn|void|0 \| 0x0|PressIn|
|InputPressOut|void|0 \| 0x0|PressOut|
...
|InputSetPosition|float|0 \| 0x0|SetPosition|
|InputSetPositionImmediately|float|0 \| 0x0|SetPositionImmediately|
...
|m_toggle_state|integer|864 \| 0x360||
|m_flMoveDistance|float|868 \| 0x364||
|m_flWait|float|872 \| 0x368||
|m_flLip|float|876 \| 0x36c||
|m_vecPosition1|pos-vector|880 \| 0x370||
|m_vecPosition2|pos-vector|892 \| 0x37c||
|m_vecMoveAng|vector|904 \| 0x388||
|m_vecAngle1|vector|916 \| 0x394||
|m_vecAngle2|vector|928 \| 0x3a0||
|m_flHeight|float|940 \| 0x3ac||
|m_hActivator|ehandle|944 \| 0x3b0||
|m_vecFinalDest|pos-vector|948 \| 0x3b4||
|m_vecFinalAngle|vector|960 \| 0x3c0||
|m_movementType|integer|972 \| 0x3cc||
|m_sMaster|string|980 \| 0x3d4||
|m_vecMoveDir|vector|984 \| 0x3d8|movedir|
|m_fStayPushed|boolean|996 \| 0x3e4||
|m_fRotating|boolean|997 \| 0x3e5||
|m_bLockedSound|character|1040 \| 0x410||
|m_bLockedSentence|character|1041 \| 0x411||
|m_bUnlockedSound|character|1042 \| 0x412||
|m_bUnlockedSentence|character|1043 \| 0x413||
|m_bLocked|boolean|1044 \| 0x414||
|m_sounds|integer|1048 \| 0x418|sounds|
|m_flUseLockedTime|time|1052 \| 0x41c||
|m_bSolidBsp|boolean|1056 \| 0x420||
|m_bSolidBsp|boolean|1056 \| 0x420|solidbsp|
|m_sNoise|soundname|1060 \| 0x424||
|m_OnDamaged|custom|1064 \| 0x428|OnDamaged|
|m_OnPressed|custom|1088 \| 0x440|OnPressed|
|m_OnUseLocked|custom|1112 \| 0x458|OnUseLocked|
|m_OnIn|custom|1136 \| 0x470|OnIn|
|m_OnOut|custom|1160 \| 0x488|OnOut|
|m_bDisabled|boolean|1188 \| 0x4a4||
|m_Position|custom|1192 \| 0x4a8|Position|
|m_OnUnpressed|custom|1216 \| 0x4c0|OnUnpressed|
|m_OnFullyOpen|custom|1240 \| 0x4d8|OnFullyOpen|
|m_OnFullyClosed|custom|1264 \| 0x4f0|OnFullyClosed|
|m_OnReachedPosition|custom|1288 \| 0x508|OnReachedPosition|
|m_lastUsed|integer|1312 \| 0x520||
|m_start|vector|1316 \| 0x524||
|m_end|vector|1328 \| 0x530||
|m_IdealYaw|float|1340 \| 0x53c||
|m_sNoise|soundname|1344 \| 0x540||
|m_bUpdateTarget|boolean|1348 \| 0x544||
|m_direction|integer|1352 \| 0x548|StartDirection|
|m_returnSpeed|float|1356 \| 0x54c|returnspeed|
|m_flStartPosition|float|1360 \| 0x550|StartPosition|
