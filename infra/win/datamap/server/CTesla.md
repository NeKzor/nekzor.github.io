...
|CTeslaShootArcThink|void|0 \| 0x0||
...
|InputDoSpark|void|0 \| 0x0|DoSpark|
...
|m_SourceEntityName|string|864 \| 0x360|m_SourceEntityName|
|m_SoundName|string|868 \| 0x364|m_SoundName|
|m_Color|color32|872 \| 0x368|m_Color|
|m_NumBeams[0]|integer|876 \| 0x36c|beamcount_min|
|m_NumBeams[1]|integer|880 \| 0x370|beamcount_max|
|m_flRadius|float|884 \| 0x374|m_flRadius|
|m_flThickness[0]|float|888 \| 0x378|thick_min|
|m_flThickness[1]|float|892 \| 0x37c|thick_max|
|m_flTimeVisible[0]|float|896 \| 0x380|lifetime_min|
|m_flTimeVisible[1]|float|900 \| 0x384|lifetime_max|
|m_flArcInterval[0]|float|904 \| 0x388|interval_min|
|m_flArcInterval[1]|float|908 \| 0x38c|interval_max|
|m_bOn|boolean|912 \| 0x390|m_bOn|
|m_iszSpriteName|string|916 \| 0x394|texture|
