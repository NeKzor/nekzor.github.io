...
|m_nHaloIndex|modelindex|864 \| 0x360||
|m_bSpotlightOn|boolean|868 \| 0x364||
|m_bHasDynamicLight|boolean|869 \| 0x365||
|m_flSpotlightMaxLength|float|872 \| 0x368|SpotlightLength|
|m_flSpotlightGoalWidth|float|876 \| 0x36c|SpotlightWidth|
|m_flHDRColorScale|float|880 \| 0x370|HDRColorScale|
|m_nRotationAxis|integer|888 \| 0x378||
|m_flRotationSpeed|float|892 \| 0x37c||
|m_flmaxSpeed|float|896 \| 0x380|maxspeed|
|m_isRotating|boolean|900 \| 0x384||
|m_isReversed|boolean|901 \| 0x385||
|m_OnOn|custom|904 \| 0x388|OnLightOn|
|m_OnOff|custom|928 \| 0x3a0|OnLightOff|
