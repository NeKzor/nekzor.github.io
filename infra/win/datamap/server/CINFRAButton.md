...
|---|:-:|:-:|--:|
|CBaseDoorCloseAreaPortalsThink|void|0 \| 0x0||
|CBaseDoorDoorGoDown|void|0 \| 0x0||
|CBaseDoorDoorGoUp|void|0 \| 0x0||
|CBaseDoorDoorHitBottom|void|0 \| 0x0||
|CBaseDoorDoorHitTop|void|0 \| 0x0||
|CBaseDoorDoorTouch|void|0 \| 0x0||
|CBaseDoorMovingSoundThink|void|0 \| 0x0||
...
|InputSetToggleState|float|0 \| 0x0|SetToggleState|
...
|m_ls.sLockedSound|soundname|1000 \| 0x3e8|locked_sound|
|m_ls.sUnlockedSound|soundname|1008 \| 0x3f0|unlocked_sound|
|m_bLockedSentence|character|1036 \| 0x40c||
|m_bUnlockedSentence|character|1037 \| 0x40d||
|m_bForceClosed|boolean|1038 \| 0x40e|forceclosed|
|m_bDoorGroup|boolean|1039 \| 0x40f||
|m_bLocked|boolean|1040 \| 0x410||
|m_bIgnoreDebris|boolean|1041 \| 0x411|ignoredebris|
|m_eSpawnPosition|integer|1044 \| 0x414|spawnpos|
|m_flBlockDamage|float|1048 \| 0x418|dmg|
|m_NoiseMoving|soundname|1052 \| 0x41c|noise1|
|m_NoiseArrived|soundname|1056 \| 0x420|noise2|
|m_NoiseMovingClosed|soundname|1060 \| 0x424|startclosesound|
|m_NoiseArrivedClosed|soundname|1064 \| 0x428|closesound|
|m_ChainTarget|string|1068 \| 0x42c|chainstodoor|
|m_flWaveHeight|float|1072 \| 0x430|WaveHeight|
|m_OnBlockedClosing|custom|1076 \| 0x434|OnBlockedClosing|
|m_OnBlockedOpening|custom|1100 \| 0x44c|OnBlockedOpening|
|m_OnUnblockedClosing|custom|1124 \| 0x464|OnUnblockedClosing|
|m_OnUnblockedOpening|custom|1148 \| 0x47c|OnUnblockedOpening|
|m_OnFullyClosed|custom|1172 \| 0x494|OnFullyClosed|
|m_OnFullyOpen|custom|1196 \| 0x4ac|OnFullyOpen|
|m_OnClose|custom|1220 \| 0x4c4|OnClose|
|m_OnOpen|custom|1244 \| 0x4dc|OnOpen|
|m_OnLockedUse|custom|1268 \| 0x4f4|OnLockedUse|
|m_bLoopMoveSound|boolean|1292 \| 0x50c|loopmovesound|
|onStartPressing|custom|1296 \| 0x510|OnStartPressing|
|onStopPressing|custom|1320 \| 0x528|OnStopPressing|
|onPressed|custom|1344 \| 0x540|OnPressed|
|onDamaged|custom|1368 \| 0x558|OnDamaged|
