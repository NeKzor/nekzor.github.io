...
|m_bDisabled|boolean|984 \| 0x3d8|StartDisabled|
|m_iFilterName|string|988 \| 0x3dc|filtername|
|m_hFilter|ehandle|992 \| 0x3e0||
|m_OnStartTouch|custom|996 \| 0x3e4|OnStartTouch|
|m_OnStartTouchAll|custom|1020 \| 0x3fc|OnStartTouchAll|
|m_OnEndTouch|custom|1044 \| 0x414|OnEndTouch|
|m_OnEndTouchAll|custom|1068 \| 0x42c|OnEndTouchAll|
|m_OnTouching|custom|1092 \| 0x444|OnTouching|
|m_OnNotTouching|custom|1116 \| 0x45c|OnNotTouching|
|m_hTouchingEntities|custom|1140 \| 0x474||
|m_flRefireDelay|time|1168 \| 0x490||
|m_flPlayerVelocity|float|1304 \| 0x518|playerSpeed|
|m_flPhysicsVelocity|float|1308 \| 0x51c|physicsSpeed|
|m_vecLaunchAngles|vector|1312 \| 0x520|launchDirection|
|m_strLaunchTarget|string|1324 \| 0x52c|launchTarget|
|m_ExactVelocityChoice|integer|1328 \| 0x530|exactVelocityChoiceType|
|m_bUseExactVelocity|boolean|1332 \| 0x534|useExactVelocity|
|m_bUseThresholdCheck|boolean|1333 \| 0x535|useThresholdCheck|
|m_flLowerThreshold|float|1336 \| 0x538|lowerThreshold|
|m_flUpperThreshold|float|1340 \| 0x53c|upperThreshold|
|m_flEntryAngleTolerance|float|1344 \| 0x540|EntryAngleTolerance|
|m_hLaunchTarget|ehandle|1348 \| 0x544||
|m_bOnlyVelocityCheck|boolean|1352 \| 0x548|onlyVelocityCheck|
|m_bApplyAngularImpulse|boolean|1353 \| 0x549|applyAngularImpulse|
|m_flAirControlSupressionTime|float|1356 \| 0x54c|AirCtrlSupressionTime|
|m_bDirectionSuppressAirControl|boolean|1360 \| 0x550|DirectionSuppressAirControl|
|m_OnCatapulted|custom|1364 \| 0x554|OnCatapulted|
|m_hAbortedLaunchees|custom|1388 \| 0x56c||
