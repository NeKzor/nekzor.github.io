...
|m_flWaveHeight|float|868 \| 0x364|
|m_WorldMins|vector|872 \| 0x368|
|m_WorldMaxs|vector|884 \| 0x374|
|m_flMaxOccludeeArea|float|896 \| 0x380|
|m_flMinOccluderArea|float|900 \| 0x384|
|m_flMinPropScreenSpaceWidth|float|904 \| 0x388|
|m_flMaxPropScreenSpaceWidth|float|908 \| 0x38c|
|m_iszDetailSpriteMaterial|string|912 \| 0x390|
|m_bStartDark|int|916 \| 0x394|
|m_bColdWorld|int|917 \| 0x395|
|m_nMaxBlobCount|int|928 \| 0x3a0|
|m_flDestAlphaScale|float|932 \| 0x3a4|
