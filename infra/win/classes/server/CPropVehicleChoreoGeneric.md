...
|m_hPlayer|int|1668 \| 0x684|
|m_vehicleView.bClampEyeAngles|int|1676 \| 0x68c|
|m_vehicleView.flPitchCurveZero|float|1680 \| 0x690|
|m_vehicleView.flPitchCurveLinear|float|1684 \| 0x694|
|m_vehicleView.flRollCurveZero|float|1688 \| 0x698|
|m_vehicleView.flRollCurveLinear|float|1692 \| 0x69c|
|m_vehicleView.flFOV|float|1696 \| 0x6a0|
|m_vehicleView.flYawMin|float|1700 \| 0x6a4|
|m_vehicleView.flYawMax|float|1704 \| 0x6a8|
|m_vehicleView.flPitchMin|float|1708 \| 0x6ac|
|m_vehicleView.flPitchMax|float|1712 \| 0x6b0|
|m_bEnterAnimOn|int|2185 \| 0x889|
|m_bExitAnimOn|int|2186 \| 0x88a|
|m_vecEyeExitEndpoint|vector|2188 \| 0x88c|
|m_bForceEyesToAttachment|int|2204 \| 0x89c|
...
|m_bUseHitboxesForRenderBox|int|1636 \| 0x664|
