...
|m_flRefireDelay|[m_flRefireDelay](#m_flRefireDelay)|1168 \| 0x490|
|m_flPlayerVelocity|float|1304 \| 0x518|
|m_flPhysicsVelocity|float|1308 \| 0x51c|
|m_vecLaunchAngles|vector|1312 \| 0x520|
|m_ExactVelocityChoice|int|1328 \| 0x530|
|m_bUseExactVelocity|int|1332 \| 0x534|
|m_bUseThresholdCheck|int|1333 \| 0x535|
|m_flLowerThreshold|float|1336 \| 0x538|
|m_flUpperThreshold|float|1340 \| 0x53c|
|m_flEntryAngleTolerance|float|1344 \| 0x540|
|m_hLaunchTarget|int|1348 \| 0x544|
|m_bOnlyVelocityCheck|int|1352 \| 0x548|
|m_bApplyAngularImpulse|int|1353 \| 0x549|
|m_bPlayersPassTriggerFilters|int|1354 \| 0x54a|
|m_flAirControlSupressionTime|float|1356 \| 0x54c|
|m_bDirectionSuppressAirControl|int|1360 \| 0x550|
...
|m_bClientSidePredicted|int|1160 \| 0x488|
