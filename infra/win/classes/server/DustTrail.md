...
|m_Color|vector|864 \| 0x360|
|m_Opacity|float|876 \| 0x36c|
|m_SpawnRate|float|880 \| 0x370|
|m_ParticleLifetime|float|884 \| 0x374|
|m_StopEmitTime|float|888 \| 0x378|
|m_MinSpeed|float|892 \| 0x37c|
|m_MaxSpeed|float|896 \| 0x380|
|m_StartSize|float|900 \| 0x384|
|m_EndSize|float|904 \| 0x388|
|m_SpawnRadius|float|908 \| 0x38c|
|m_MinDirectedSpeed|float|912 \| 0x390|
|m_MaxDirectedSpeed|float|916 \| 0x394|
