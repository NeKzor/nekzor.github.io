...
|m_szMaterialName|string|864 \| 0x360|
|m_szMaterialVar|string|1119 \| 0x45f|
|m_szMaterialVarValue|string|1374 \| 0x55e|
|m_iFrameStart|int|1632 \| 0x660|
|m_iFrameEnd|int|1636 \| 0x664|
|m_bWrap|int|1640 \| 0x668|
|m_flFramerate|float|1644 \| 0x66c|
|m_bNewAnimCommandsSemaphore|int|1648 \| 0x670|
|m_flFloatLerpStartValue|float|1652 \| 0x674|
|m_flFloatLerpEndValue|float|1656 \| 0x678|
|m_flFloatLerpTransitionTime|float|1660 \| 0x67c|
|m_nModifyMode|int|1664 \| 0x680|
